...
function mS(e, t, n) {
    var r,
        ...
        l = null,
        s = null;
    if (t != null) for (r in (t.ref !== void 0 && (s = t.ref), t.key !== void 0 && (l = "" + t.key), t)) hS.call(t, r) && !gS.hasOwnProperty(r) && (i[r] = t[r]);
...
function Qa(e, t, n, r, i) {
    ...
    if (s)
        return (
            ...
            c1(i)
                ...
                : i != null && (Bg(i) && (i = DA(i, n + (!i.key || (s && s.key === i.key) ? "" : ("" + i.key).replace(f1, "$&/") + "/") + e)), t.push(i)),
            1
        );
    if (((s = 0), (r = r === "" ? "." : r + ":"), c1(e)))
    ...
    else if (((f = AA(e)), typeof f == "function")) for (e = f.call(e), a = 0; !(l = e.next()).done;) (l = l.value), (f = r + fp(l, a++)), (s += Qa(l, t, n, f, i));
    else if (l === "object")
        throw (
            ((t = String(e)),
...
Ne.createContext = function (e) {
    return (e = { $$typeof: OA, _currentValue: e, _currentValue2: e, _threadCount: 0, Provider: null, Consumer: null, _defaultValue: null, _globalName: null }), (e.Provider = { $$typeof: bA, _context: e }), (e.Consumer = e);
};
Ne.createElement = mS;
 ...
 */ (function (e) {
    ...
    (e.unstable_IdlePriority = 5),
        ...
        (e.unstable_scheduleCallback = function (j, J, b) {
            ...
            return (
                (ae = b + ae),
                (j = { id: p++, callback: J, priorityLevel: j, startTime: b, expirationTime: ae, sortIndex: -1 }),
                b > ne ? ((j.sortIndex = b), t(d, j), n(f) === null && j === n(d) && (S ? (y(z), (z = -1)) : (S = !0), oe(P, b - ne))) : ((j.sortIndex = ae), t(f, j), E || m || ((E = !0), ue(N))),
                j
            );
        }),
...
function Eh(e, t) {
    var n = t.checked;
    return vt({}, t, { defaultChecked: void 0, defaultValue: void 0, value: void 0, checked: n ?? e._wrapperState.initialChecked });
}
function g1(e, t) {
    var n = t.defaultValue == null ? "" : t.defaultValue,
        r = t.checked != null ? t.checked : t.defaultChecked;
    (n = Zi(t.value != null ? t.value : n)), (e._wrapperState = { initialChecked: r, initialValue: n, controlled: t.type === "checkbox" || t.type === "radio" ? t.checked != null : t.value != null });
}
function IS(e, t) {
...
function _h(e, t) {
    ...
    return vt({}, t, { value: void 0, defaultValue: void 0, children: "" + e._wrapperState.initialValue });
}
function v1(e, t) {
    var n = t.value;
    if (n == null) {
...
var JA = vt({ menuitem: !0 }, { area: !0, base: !0, br: !0, col: !0, embed: !0, hr: !0, img: !0, input: !0, keygen: !0, link: !0, meta: !0, param: !0, source: !0, track: !0, wbr: !0 });
function Oh(e, t) {
    if (t) {
...
function mc(e, t) {
    ...
    if ((r & 4 && (r |= n & 16), (t = e.entangledLanes), t !== 0)) for (e = e.entanglements, t &= r; 0 < t;) (n = 31 - Cr(t)), (i = 1 << n), (r |= e[n]), (t &= ~i);
    return r;
}
function pD(e, t) {
    switch (e) {
...
function bu(e, t, n, r, i, l) {
    return e === null || e.nativeEvent !== l
        ? ((e = { blockedOn: t, domEventName: n, eventSystemFlags: r, nativeEvent: l, targetContainers: [i] }), t !== null && ((t = Ts(t)), t !== null && Xg(t)), e)
...
var Jl = {
    ...
    ID = vt({}, Jl, { data: 0 }),
    b1 = Hn(ID),
    RD = { Esc: "Escape", Spacebar: " ", Left: "ArrowLeft", Up: "ArrowUp", Right: "ArrowRight", Down: "ArrowDown", Del: "Delete", Win: "OS", Menu: "ContextMenu", Apps: "ContextMenu", Scroll: "ScrollLock", MozPrintableKey: "Unidentified" },
    PD = {
        8: "Backspace",
        9: "Tab",
        12: "Clear",
...
var ND = vt({}, Os, {
    ...
    MD = Hn(ND),
    LD = vt({}, rf, { pointerId: 0, width: 0, height: 0, pressure: 0, tangentialPressure: 0, tiltX: 0, tiltY: 0, twist: 0, pointerType: 0, isPrimary: 0 }),
    O1 = Hn(LD),
    FD = vt({}, Os, { touches: 0, targetTouches: 0, changedTouches: 0, altKey: 0, metaKey: 0, ctrlKey: 0, shiftKey: 0, getModifierState: tm }),
    zD = Hn(FD),
...
function iE(e, t, n, r) {
    MS(r), (t = wc(t, "onChange")), 0 < t.length && ((n = new em("onChange", "change", null, n, r)), e.push({ event: n, listeners: t }));
}
var Wu = null,
    as = null;
function KD(e) {
...
function M1(e, t, n) {
    ...
    Fh ||
        ...
        ((r = vl),
            ...
            (Vu && cs(Vu, r)) || ((Vu = r), (r = wc(Lh, "onSelect")), 0 < r.length && ((t = new em("onSelect", "select", null, t, n)), e.push({ event: t, listeners: r }), (t.target = vl))));
}
function Aa(e, t) {
    var n = {};
    return (n[e.toLowerCase()] = t.toLowerCase()), (n["Webkit" + e] = "webkit" + t), (n["Moz" + e] = "moz" + t), n;
}
var yl = { animationend: Aa("Animation", "AnimationEnd"), animationiteration: Aa("Animation", "AnimationIteration"), animationstart: Aa("Animation", "AnimationStart"), transitionend: Aa("Transition", "TransitionEnd") },
    Ep = {},
    aE = {};
si &&
    ((aE = document.createElement("div").style),
        "AnimationEvent" in window || (delete yl.animationend.animation, delete yl.animationiteration.animation, delete yl.animationstart.animation),
    ...
    $S(function () {
        ...
        if (!(t & 7)) {
            e: {
                ...
                if (
                    ...
                    ((v = p.window === p ? p : (v = p.ownerDocument) ? v.defaultView || v.parentWindow : window),
                        m ? ((E = n.relatedTarget || n.toElement), (m = d), (E = E ? bo(E) : null), E !== null && ((A = Wo(E)), E !== A || (E.tag !== 5 && E.tag !== 6)) && (E = null)) : ((m = null), (E = d)),
                        m !== E)
                ) {
                    if (
                        ((S = _1),
                            ...
                            (y = "onMouseEnter"),
                            (x = "mouse"),
                            (e === "pointerout" || e === "pointerover") && ((S = O1), (P = "onPointerLeave"), (y = "onPointerEnter"), (x = "pointer")),
                            (A = m == null ? v : wl(m)),
                            (k = E == null ? v : wl(E)),
                            ...
                            (v.relatedTarget = k),
                            (P = null),
                            bo(p) === d && ((S = new S(y, x + "enter", E, n, p)), (S.target = k), (S.relatedTarget = A), (P = S)),
                            (A = P),
                            m && E)
                    )
                        t: {
            ...
            e: {
                ...
                T && T(e, v, d), e === "focusout" && (T = v._wrapperState) && T.controlled && v.type === "number" && kh(v, "number", v.value);
            }
            ...
            else ml ? nE(e, n) && (z = "onCompositionEnd") : e === "keydown" && n.keyCode === 229 && (z = "onCompositionStart");
            z &&
                (tE && n.locale !== "ko" && (ml || z !== "onCompositionStart" ? z === "onCompositionEnd" && ml && (F = eE()) : ((Fi = p), (Jg = "value" in Fi ? Fi.value : Fi.textContent), (ml = !0))),
                    (T = wc(d, z)),
                    0 < T.length && ((z = new b1(z, e, null, n, p)), g.push({ event: z, listeners: T }), F ? (z.data = F) : ((F = rE(n)), F !== null && (z.data = F)))),
                (F = WD ? VD(e, n) : qD(e, n)) && ((d = wc(d, "onBeforeInput")), 0 < d.length && ((p = new b1("onBeforeInput", "beforeinput", null, n, p)), g.push({ event: p, listeners: d }), (p.data = F)));
        }
        gE(g, t);
    });
}
...
function EE(e) {
    ...
    function f(y, x, k, P) {
        ...
        return N === gl
            ...
            : x !== null && (x.elementType === N || (typeof N == "object" && N !== null && N.$$typeof === Pi && q1(N) === x.type))
                ? ((P = i(x, k.props)), (P.ref = Iu(y, x, k)), (P.return = y), P)
                : ((P = lc(k.type, k.key, k.props, null, y.mode, P)), (P.ref = Iu(y, x, k)), (P.return = y), P);
    }
    function d(y, x, k, P) {
    ...
    function A(y, x, k, P) {
        ...
        return (typeof k == "string" && k !== "") || typeof k == "number"
            ? ((k = "" + k), x !== null && x.tag === 6 ? (n(y, x.sibling), (x = i(x, k)), (x.return = y), (y = x)) : (n(y, x), (x = Mp(k, y.mode, P)), (x.return = y), (y = x)), s(y))
            : n(y, x);
    }
    return A;
}
    ...
    if (l !== null) {
        ...
        do {
            var v = a.lane,
                m = a.eventTime;
            if ((r & v) === v) {
                p !== null && (p = p.next = { eventTime: m, lane: 0, tag: a.tag, payload: a.payload, callback: a.callback, next: null });
                e: {
                    var E = e,
                        S = a;
            ...
            } else (m = { eventTime: m, lane: v, tag: a.tag, payload: a.payload, callback: a.callback, next: null }), p === null ? ((d = p = m), (f = g)) : (p = p.next = m), (s |= v);
            if (((a = a.next), a === null)) {
...
function ar() {
    ...
    if (t !== null) (At = t), (Tt = e);
        ...
        (Tt = e), (e = { memoizedState: Tt.memoizedState, baseState: Tt.baseState, baseQueue: Tt.baseQueue, queue: Tt.queue, next: null }), At === null ? (mt.memoizedState = At = e) : (At = At.next = e);
    }
    return At;
}
function vs(e, t) {
...
function Pp(e) {
    ...
    if (i !== null) {
        ...
        do {
            var p = d.lane;
            if ((Lo & p) === p) f !== null && (f = f.next = { lane: 0, action: d.action, hasEagerState: d.hasEagerState, eagerState: d.eagerState, next: null }), (r = d.hasEagerState ? d.eagerState : e(r, d.action));
            else {
                var g = { lane: p, action: d.action, hasEagerState: d.hasEagerState, eagerState: d.eagerState, next: null };
...
function Q1(e) {
    ...
    return (
        ...
        (e = { pending: null, interleaved: null, lanes: 0, dispatch: null, lastRenderedReducer: vs, lastRenderedState: e }),
        (t.queue = e),
...
function ys(e, t, n, r) {
    return (
        ...
        (t = mt.updateQueue),
        t === null
            ? ((t = { lastEffect: null, stores: null }), (mt.updateQueue = t), (t.lastEffect = e.next = e))
...
function vN(e, t, n) {
    var r = Vi(e);
    if (((n = { lane: r, action: n, hasEagerState: !1, eagerState: null, next: null }), jE(e))) WE(t, n);
...
function qE(e, t, n) {
    var r = !1,
        ...
        l = t.contextType;
    return (
        typeof l == "object" && l !== null ? (l = sr(l)) : ((i = wn(t) ? No : Xt.current), (r = t.contextTypes), (l = (r = r != null) ? $l(e, i) : Ji)),
        (t = new t(n, l)),
...
function Kh(e, t, n, r) {
    ...
    var l = t.contextType;
    typeof l == "object" && l !== null ? (i.context = sr(l)) : ((l = wn(t) ? No : Xt.current), (i.context = $l(e, l))),
...
function tw(e, t, n, r, i) {
    return e.mode & 1
        ...
        : (e === t ? (e.flags |= 65536) : ((e.flags |= 128), (n.flags |= 131072), (n.flags &= -52805), n.tag === 1 && (n.alternate === null ? (n.tag = 17) : ((t = ui(-1, 1)), (t.tag = 2), ji(n, t, 1))), (n.lanes |= 1)), e);
}
...
function rw(e, t, n, r, i) {
    if (e === null) {
        var l = n.type;
        return typeof l == "function" && !Om(l) && l.defaultProps === void 0 && n.compare === null && n.defaultProps === void 0
...
function YE(e, t, n) {
    ...
    if (r.mode === "hidden")
        if (!(t.mode & 1)) (t.memoizedState = { baseLanes: 0, cachePool: null, transitions: null }), nt(_l, Dn), (Dn |= n);
        else {
            if (!(n & 1073741824))
                return (e = l !== null ? l.baseLanes | n : n), (t.lanes = t.childLanes = 1073741824), (t.memoizedState = { baseLanes: e, cachePool: null, transitions: null }), (t.updateQueue = null), nt(_l, Dn), (Dn |= e), null;
            (t.memoizedState = { baseLanes: 0, cachePool: null, transitions: null }), (r = l !== null ? l.baseLanes : n), nt(_l, Dn), (Dn |= r);
        }
...
function Yh(e, t, n, r, i) {
    ...
    return (
        (l = $l(t, l)), Rl(t, i), (n = mm(e, t, n, r, l, i)), (r = vm()), e !== null && !mn ? ((t.updateQueue = e.updateQueue), (t.flags &= -2053), (e.lanes &= ~i), fi(e, t, i)) : (pt && r && im(t), (t.flags |= 1), nn(e, t, n, i), t.child)
    );
}
function iw(e, t, n, r, i) {
    ...
    if ((Rl(t, i), t.stateNode === null)) rc(e, t), qE(t, n, r), Kh(t, n, r, i), (r = !0);
            ...
            a !== r || v !== f || yn.current || Ai
                ? (typeof p == "function" && (Gh(t, n, p, r), (f = t.memoizedState)),
                    (a = Ai || X1(t, n, a, r, v, f, d))
                        ...
                        : (typeof s.componentDidMount == "function" && (t.flags |= 4194308), (t.memoizedProps = r), (t.memoizedState = f)),
                    (s.props = r),
                    (s.state = f),
                    (s.context = d),
                    (r = a))
        ...
        (s = t.stateNode),
            ...
            (v = s.context),
            (f = n.contextType),
            typeof f == "object" && f !== null ? (f = sr(f)) : ((f = wn(n) ? No : Xt.current), (f = $l(t, f)));
            ...
            ? (typeof m == "function" && (Gh(t, n, m, r), (E = t.memoizedState)),
                (d = Ai || X1(t, n, d, r, v, E, f) || !1)
                    ? (p ||
                        ...
                        (typeof s.componentWillUpdate == "function" && s.componentWillUpdate(r, E, f), typeof s.UNSAFE_componentWillUpdate == "function" && s.UNSAFE_componentWillUpdate(r, E, f)),
...
function JE(e, t, n) {
    var r = t.pendingProps,
        ...
        s = (t.flags & 128) !== 0,
        a;
    if (((a = s) || (a = e !== null && e.memoizedState === null ? !1 : (i & 2) !== 0), a ? ((l = !0), (t.flags &= -129)) : (e === null || e.memoizedState !== null) && (i |= 1), nt(gt, i & 1), e === null))
        return (
            Vh(t),
            (e = t.memoizedState),
                ...
                : ((s = r.children),
                    ...
                    l
                        ? ((r = t.mode),
                            ...
                            !(r & 1) && l !== null ? ((l.childLanes = 0), (l.pendingProps = s)) : (l = pf(s, r, 0, null)),
                            (e = Po(e, r, n, null)),
                            (l.return = t),
                            (e.return = t),
                            (l.sibling = e),
    ...
    if (l) {
        ...
        return (
            !(s & 1) && t.child !== i ? ((r = t.child), (r.childLanes = 0), (r.pendingProps = f), (t.deletions = null)) : ((r = qi(i, f)), (r.subtreeFlags = i.subtreeFlags & 14680064)),
            ...
            (s = s === null ? Jh(n) : { baseLanes: s.baseLanes | n, cachePool: null, transitions: s.transitions }),
            (l.memoizedState = s),
...
function kN(e, t, n, r, i, l, s) {
    ...
    return i.data === "$?"
        ...
        : ((e = l.treeContext),
            ...
            (pt = !0),
            (Sr = null),
            e !== null && ((tr[nr++] = oi), (tr[nr++] = li), (tr[nr++] = Mo), (oi = e.id), (li = e.overflow), (Mo = t)),
            (t = xm(t, r.children)),
            (t.flags |= 4096),
            t);
}
    ...
    switch (t.tag) {
        ...
        case 13:
            if (((r = t.memoizedState), r !== null))
                return r.dehydrated !== null ? (nt(gt, gt.current & 1), (t.flags |= 128), null) : n & t.child.childLanes ? JE(e, t, n) : (nt(gt, gt.current & 1), (e = fi(e, t, n)), e !== null ? e.sibling : null);
            nt(gt, gt.current & 1);
            break;
        case 19:
        ...
        for (d in r) {
            ...
            if (((a = i?.[d]), r.hasOwnProperty(d) && f !== a && (f != null || a != null)))
                if (d === "style")
                    ...
                    d === "dangerouslySetInnerHTML"
                        ? ((f = f ? f.__html : void 0), (a = a ? a.__html : void 0), f != null && a !== f && (l = l || []).push(d, f))
                        : d === "children"
                            ? (typeof f != "string" && typeof f != "number") || (l = l || []).push(d, "" + f)
                            : d !== "suppressContentEditableWarning" && d !== "suppressHydrationWarning" && (rs.hasOwnProperty(d) ? (f != null && d === "onScroll" && lt("scroll", e), l || a === f || (l = [])) : (l = l || []).push(d, f));
        }
        n && (l = l || []).push("style", n);
        var d = l;
    ...
    switch ((om(t), t.tag)) {
        ...
        case 3:
            return (
                ...
                (e === null || e.child === null) && (Ma(t) ? (t.flags |= 4) : e === null || (e.memoizedState.isDehydrated && !(t.flags & 256)) || ((t.flags |= 1024), Sr !== null && (sg(Sr), (Sr = null)))),
                eg(e, t),
                qt(t),
                null
            );
                ...
                if (((e = To($r.current)), Ma(t))) {
                    ...
                    for (var s in l)
                        if (l.hasOwnProperty(s)) {
                            ...
                            s === "children"
                                ? typeof a == "string"
                                    ? r.textContent !== a && (l.suppressHydrationWarning !== !0 && Na(r.textContent, a, e), (i = ["children", a]))
                                    : typeof a == "number" && r.textContent !== "" + a && (l.suppressHydrationWarning !== !0 && Na(r.textContent, a, e), (i = ["children", "" + a]))
                    ...
                    e: {
                        switch (((s = Th(n, r)), n)) {
                            ...
                            case "option":
                                ...
                                break;
                            case "select":
                                (e._wrapperState = { wasMultiple: !!r.multiple }), (i = vt({}, r, { value: void 0 })), lt("invalid", e);
                                break;
                            case "textarea":
                                ...
                                l === "style"
                                    ...
                                    : l === "dangerouslySetInnerHTML"
                                        ...
                                        : l === "children"
                                            ...
                                            l !== "autoFocus" &&
                                            (rs.hasOwnProperty(l) ? f != null && l === "onScroll" && lt("scroll", e) : f != null && Wg(e, l, f, s));
                            }
                        switch (n) {
                            case "input":
                                ba(e), m1(e, r, !1);
        ...
        case 6:
            if (e && t.stateNode != null) rC(e, t, e.memoizedProps, r);
                ...
                if (((n = To(gs.current)), To($r.current), Ma(t))) {
                    if (((r = t.stateNode), (n = t.memoizedProps), (r[Mr] = t), (l = r.nodeValue !== n) && ((e = Fn), e !== null)))
                        switch (e.tag) {
                            case 3:
        ...
        case 13:
            ...
            return t.flags & 128
                ? ((t.lanes = n), t)
                : ((r = r !== null),
                    r !== (e !== null && e.memoizedState !== null) && r && ((t.child.flags |= 8192), t.mode & 1 && (e === null || gt.current & 1 ? It === 0 && (It = 3) : bm())),
                ...
                if (r) Ru(l, !1);
                    ...
                    if (It !== 0 || (e !== null && e.flags & 128))
                        for (e = t.child; e !== null;) {
                            if (((s = Tc(e)), s !== null)) {
                                for (t.flags |= 128, Ru(l, !1), r = s.updateQueue, r !== null && ((t.updateQueue = r), (t.flags |= 4)), t.subtreeFlags = 0, r = n, n = t.child; n !== null;)
                                    (l = n),
                                        (e = r),
                                        (l.flags &= 14680066),
                                        (s = l.alternate),
            ...
            e: {
                ...
                if (r && r.rangeCount !== 0) {
                    ...
                    var s = 0,
                        ...
                        v = null;
                    t: for (; ;) {
                        for (var m; g !== n || (i !== 0 && g.nodeType !== 3) || (a = s + i), g !== l || (r !== 0 && g.nodeType !== 3) || (f = s + r), g.nodeType === 3 && (s += g.nodeValue.length), (m = g.firstChild) !== null;)
                            (v = g), (g = m);
                        for (; ;) {
                            if (g === e) break t;
...
function iC(e) {
    ...
    t !== null && ((e.alternate = null), iC(t)),
        ...
        (e.deletions = null),
        (e.sibling = null),
        e.tag === 5 && ((t = e.stateNode), t !== null && (delete t[Mr], delete t[ps], delete t[Hh], delete t[fN], delete t[dN])),
        (e.stateNode = null),
        (e.return = null),
        (e.dependencies = null),
        ...
        (e = e.stateNode),
            t
                ? n.nodeType === 8
                    ...
                    : n.insertBefore(e, t)
                : (n.nodeType === 8 ? ((t = n.parentNode), t.insertBefore(e, n)) : ((t = n), t.appendChild(e)), (n = n._reactRootContainer), n != null || t.onclick !== null || (t.onclick = xc));
    else if (r !== 4 && ((e = e.child), e !== null)) for (rg(e, t, n), e = e.sibling; e !== null;) rg(e, t, n), (e = e.sibling);
}
function ig(e, t, n) {
    var r = e.tag;
    if (r === 5 || r === 6) (e = e.stateNode), t ? n.insertBefore(e, t) : n.appendChild(e);
    else if (r !== 4 && ((e = e.child), e !== null)) for (ig(e, t, n), e = e.sibling; e !== null;) ig(e, t, n), (e = e.sibling);
}
var zt = null,
    xr = !1;
function Oi(e, t, n) {
                            ...
                            try {
                                (i = g.stateNode),
                                    d
                                        ...
                                        : ((a = g.stateNode), (f = g.memoizedProps.style), (s = f != null && f.hasOwnProperty("display") ? f.display : null), (a.style.display = DS("display", s)));
                            } catch (S) {
                                xt(e, e.return, S);
                            }
                        }
    ...
    for (var r = (e.mode & 1) !== 0; ce !== null;) {
        ...
        if (i.tag === 22 && r) {
            ...
            if (!s) {
                ...
                a = za;
                var d = Qt;
                if (((za = s), (Qt = f) && !d)) for (ce = i; ce !== null;) (s = ce), (f = s.child), s.tag === 22 && s.memoizedState !== null ? dw(i) : f !== null ? ((f.return = s), (ce = f)) : dw(i);
            ...
            e: {
                ...
                if (((r = s.element), l.isDehydrated))
                    if (((l = { element: r, isDehydrated: !1, cache: s.cache, pendingSuspenseBoundaries: s.pendingSuspenseBoundaries, transitions: s.transitions }), (t.updateQueue.baseState = l), (t.memoizedState = l), t.flags & 256)) {
                        ...
                        break e;
                    } else for (Mn = Hi(t.stateNode.containerInfo.firstChild), Fn = t, pt = !0, Sr = null, n = CE(t, null, r, n), t.child = n; n;) (n.flags = (n.flags & -3) | 4096), (n = n.sibling);
                else {
                    if ((Bl(), r === i)) {
                        t = fi(e, t, n);
                        break e;
...
function qi(e, t) {
    ...
    return (
        n === null
            ? ((n = or(e.tag, t, e.key, e.mode)), (n.elementType = e.elementType), (n.type = e.type), (n.stateNode = e.stateNode), (n.alternate = e), (e.alternate = n))
...
function pf(e, t, n, r) {
    return (e = or(22, e, r, t)), (e.elementType = bS), (e.lanes = n), (e.stateNode = { isHidden: !1 }), e;
}
function Mp(e, t, n) {
    return (e = or(6, e, null, t)), (e.lanes = n), e;
}
function Lp(e, t, n) {
    return (t = or(4, e.children !== null ? e.children : [], e.key, t)), (t.lanes = n), (t.stateNode = { containerInfo: e.containerInfo, pendingChildren: null, implementation: e.implementation }), t;
}
...
function HN(e, t, n) {
    ...
    return { $$typeof: hl, key: r == null ? null : "" + r, children: e, containerInfo: t, implementation: n };
}
function vC(e) {
    if (!e) return Ji;
    e = e._reactInternals;
...
var VN = { usingClientEntryPoint: !1, Events: [Ts, wl, uf, MS, LS, km] },
    Pu = { findFiberByHostInstance: bo, bundleType: 0, version: "18.3.1", rendererPackageName: "react-dom" },
    qN = {
...
function wM(e = eo) {
    ...
    return function (r, i = {}) {
        const { equalityFn: l = yM, stabilityCheck: s = void 0, noopCheck: a = void 0 } = typeof i == "function" ? { equalityFn: i } : i,
...
Xe.isValidElementType = function (e) {
    return (
        ...
        e === bf ||
        e === SM ||
        (typeof e == "object" && e !== null && (e.$$typeof === Tf || e.$$typeof === Of || e.$$typeof === Ef || e.$$typeof === Cf || e.$$typeof === _f || e.$$typeof === CM || e.$$typeof === kM || e.$$typeof === _M || e.$$typeof === EM))
    );
};
Xe.typeOf = jn;
IC.exports = Xe;
...
Ze.isValidElementType = function (e) {
    return (
        ...
        e === Lf ||
        e === RM ||
        (typeof e == "object" && e !== null && (e.$$typeof === zf || e.$$typeof === Ff || e.$$typeof === Af || e.$$typeof === Df || e.$$typeof === Nf || e.$$typeof === NC || e.getModuleId !== void 0))
    );
};
Ze.typeOf = cr;
DC.exports = Ze;
...
function NM(e, t) {
    ...
    const E = { addNestedSub: s, notifyNestedSubs: a, handleChangeWrapper: f, isSubscribed: d, trySubscribe: v, tryUnsubscribe: m, getListeners: () => r };
    return E;
}
...
function FM({ store: e, context: t, children: n, serverState: r, stabilityCheck: i = "once", noopCheck: l = "once" }) {
    const s = I.useMemo(() => {
        const d = NM(e);
        return { store: e, subscription: d, getServerState: r ? () => r : void 0, stabilityCheck: i, noopCheck: l };
    }, [e, r, i, l]),
...
function $m(e, t, n) {
    ...
    return v({ type: Fc.INIT }), (r = { dispatch: v, subscribe: g, getState: p, replaceReducer: m }), (r[Cw] = E), r;
}
function VM(e) {
...
function eL(e) {
    return function (n = [], r = { publishSource: !0 }) {
        ...
        return { type: $f, payload: { itemType: m, item: v, sourceId: d, clientOffset: l || null, sourceClientOffset: p || null, isSourcePublic: !!i } };
    };
}
function tL(e, t, n) {
...
function hL(e) {
    return function (n, { clientOffset: r } = {}) {
        ...
        const i = n.slice(0),
            ...
            s = e.getRegistry(),
            a = l.getItemType();
        return vL(i, s, a), mL(i, l, s), yL(i, l, s), { type: Bf, payload: { targetIds: i, clientOffset: r || null } };
    };
}
function gL(e) {
...
function YL(e = Tw, t) {
    ...
    switch (t.type) {
        case Bm:
        case $f:
            return { initialSourceClientOffset: n.sourceClientOffset, initialClientOffset: n.clientOffset, clientOffset: n.clientOffset };
        case Bf:
...
const ZL = { itemType: null, item: null, sourceId: null, targetIds: [], dropResult: null, didDrop: !1, isSourcePublic: null };
function JL(e = ZL, t) {
    const { payload: n } = t;
    switch (t.type) {
        case $f:
            return al({}, e, { itemType: n.itemType, item: n.item, sourceId: n.sourceId, isSourcePublic: n.isSourcePublic, dropResult: null, didDrop: !1 });
        case Um:
            return al({}, e, { isSourcePublic: !0 });
        case Bf:
            return al({}, e, { targetIds: n.targetIds });
        case jf:
            return e.targetIds.indexOf(n.targetId) === -1 ? e : al({}, e, { targetIds: YM(e.targetIds, n.targetId) });
        case Uf:
            return al({}, e, { dropResult: n.dropResult, didDrop: !0, targetIds: [] });
        case Hf:
            return al({}, e, { itemType: null, item: null, sourceId: null, dropResult: null, didDrop: !1, isSourcePublic: null, targetIds: [] });
        default:
            return e;
    }
}
...
function iF(e = {}, t) {
    return {
        dirtyHandlerIds: GL(e.dirtyHandlerIds, { type: t.type, payload: rF({}, t.payload, { prevTargetIds: QM(e, "dragOperation.targetIds", []) }) }),
...
const Pw = (() => {
    ...
    Au = { [Gi.mouse]: { start: "mousedown", move: "mousemove", end: "mouseup", contextmenu: "contextmenu" }, [Gi.touch]: { start: "touchstart", move: "touchmove", end: "touchend" }, [Gi.keyboard]: { keydown: "keydown" } };
class Xu {
    profile() {
        var t;
        return {
    ...
    setup() {
        ...
        t &&
            (_e(!Xu.isSetUp, "Cannot have two Touch backends at the same time."),
                ...
                this.options.enableMouseEvents && !this.options.ignoreContextMenu && this.addEventListener(t, "contextmenu", this.handleTopMoveEndCapture),
                this.options.enableKeyboardEvents && this.addEventListener(t, "keydown", this.handleCancelOnEscape, !0));
    }
    teardown() {
        const t = this.options.rootElement;
        t &&
            ((Xu.isSetUp = !1),
                ...
                this.options.enableMouseEvents && !this.options.ignoreContextMenu && this.removeEventListener(t, "contextmenu", this.handleTopMoveEndCapture),
                this.options.enableKeyboardEvents && this.removeEventListener(t, "keydown", this.handleCancelOnEscape, !0),
    ...
    connectDropTarget(t, n) {
        ...
        const i = (l) => {
            ...
            switch (l.type) {
                ...
                case Au.touch.move:
                    var a, f;
                    s = { x: ((a = l.touches[0]) === null || a === void 0 ? void 0 : a.clientX) || 0, y: ((f = l.touches[0]) === null || f === void 0 ? void 0 : f.clientY) || 0 };
                    break;
            }
    ...
    installSourceNodeRemovalObserver(t) {
        this.uninstallSourceNodeRemovalObserver(),
            ...
            !(!t || !t.parentElement) && this.draggedSourceNodeRemovalObserver.observe(t.parentElement, { childList: !0 });
    }
    resurrectSourceNode() {
            ...
            (this.handleTopMove = (i) => {
                ...
                if (
                    (!this.monitor.isDragging() &&
                        ...
                        l &&
                        HF(this._mouseClientOffset.x || 0, this._mouseClientOffset.y || 0, f.x, f.y) > (this.options.touchSlop ? this.options.touchSlop : 0) &&
                        ((this.moveStartSourceIds = void 0), this.actions.beginDrag(l, { clientOffset: this._mouseClientOffset, getSourceClientOffset: this.getSourceClientOffset, publishSource: !1 })),
                        !this.monitor.isDragging())
                )
                    return;
...
function Km(e) {
    ...
    for (var n = Dl(t), r = 0; r < n.length; r++) {
        var i = n[r],
            l = t[i];
        l.writable === !1 && ((l.writable = !0), (l.configurable = !0)), (l.get || l.set) && (t[i] = { configurable: !0, writable: !0, enumerable: l.enumerable, value: e[i] });
    }
            ...
            : e.O
                ? (function (i, l) {
                    var s = Array.isArray(i),
                        a = { i: s ? 1 : 0, A: l ? l.A : hg(), P: !1, I: !1, R: {}, l, t: i, k: null, o: null, j: null, C: !1 },
                        f = a,
                        d = Es;
                    s && ((f = [a]), (d = zu));
    ...
    JF("ES5", {
        J: function (l, s) {
            var a = Array.isArray(l),
                ...
                d = { i: a ? 5 : 4, A: s ? s.A : hg(), P: !1, I: !1, R: {}, l: s, t: l, k: f, o: null, g: !1, C: !1 };
                        ...
                        if (d && typeof d == "object") {
                            ...
                            if (p) {
                                ...
                                if (E === 4)
                                    ...
                                    if ((r(p) && (Mi(p), (m.length = !0)), v.length < g.length)) for (var S = v.length; S < g.length; S++) m[S] = !1;
...
var tk =
    ...
    Uw = function (e, t, n) {
        return t in e ? u3(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : (e[t] = n);
    },
    Ki = function (e, t) {
...
function Qi(e, t) {
    function n() {
        ...
        if (t) {
            ...
            return Ki(Ki({ type: e, payload: l.payload }, "meta" in l && { meta: l.meta }), "error" in l && { error: l.error });
        }
    ...
    Jm = (function () {
        function e(t, n, r) {
            var i = Qi(t + "/fulfilled", function (d, p, g, v) {
                return { payload: d, meta: Gp(Ki({}, v || {}), { arg: g, requestId: p, requestStatus: "fulfilled" }) };
            }),
                l = Qi(t + "/pending", function (d, p, g) {
                    return { payload: void 0, meta: Gp(Ki({}, g || {}), { arg: p, requestId: d, requestStatus: "pending" }) };
                }),
                s = Qi(t + "/rejected", function (d, p, g, v, m) {
                    return {
                        payload: v,
                        error: ((r && r.serializeError) || I3)(d || "Rejected"),
                        meta: Gp(Ki({}, m || {}), { arg: g, requestId: p, rejectedWithValue: !!v, requestStatus: "rejected", aborted: d?.name === "AbortError", condition: d?.name === "ConditionError" }),
                    };
                }),
                a =
                    ...
                    var y = (function () {
                        return d3(this, null, function () {
                            ...
                            return l3(this, function (q) {
                                switch (q.label) {
                                    case 0:
                                        return q.trys.push([0, 4, , 5]), (N = (x = r?.condition) == null ? void 0 : x.call(r, d, { getState: g, extra: v })), P3(N) ? [4, N] : [3, 2];
                                    case 1:
                                        (N = q.sent()), (q.label = 2);
                                    case 2:
                                        if (N === !1 || E.signal.aborted) throw { name: "ConditionError", message: "Aborted due to condition callback returning false." };
                                        return (
                                            ...
                                            p(l(m, d, (k = r?.getPendingMeta) == null ? void 0 : k.call(r, { requestId: m, arg: d }, { getState: g, extra: v }))),
                                            [
                                                4,
                                                Promise.race([
                                                    T,
...
(function (e, t) {
    (function () {
        ...
        var et = {};
        (et[Re] = et[me] = et[V] = et[re] = et[Se] = et[Le] = et[pe] = et[Ue] = et[He] = et[Zt] = et[qn] = et[yt] = et[Wn] = et[at] = et[kn] = et[Ht] = et[Or] = et[Wr] = et[_n] = et[Vr] = et[qr] = et[it] = !0),
            (et[Be] = et[Fe] = et[Tr] = !1);
        var Fb = {
            À: "A",
            Á: "A",
        ...
        function Bs(M, K, H, se) {
            for (var Ee = M.length, je = H + (se ? 1 : -1); se ? je-- : ++je < Ee;) if (K(M[je], je, M)) return je;
            return -1;
        }
        function Qo(M, K, H) {
        ...
        var pO = function M(K) {
            ...
            (C.templateSettings = { escape: G_, evaluate: K_, interpolate: Lv, variable: "", imports: { _: C } }),
            ...
            function GO() {
                (this.size = 0), (this.__data__ = { hash: new po(), map: new (cu || Gr)(), string: new po() });
            }
            function KO(o) {
            ...
            function Qr(o, u, c) {
                u == "__proto__" && Ys ? Ys(o, u, { configurable: !0, enumerable: !0, value: c, writable: !0 }) : (o[u] = c);
            }
            function Ed(o, u) {
            ...
            function Rd(o, u, c, h) {
                var w = h ? Yb : Qo,
                    ...
                    R = u.length,
                    D = o;
                for (o === u && (u = sn(u)), c && (D = ct(o, On(c))); ++_ < R;) for (var L = 0, Y = u[_], X = c ? c(Y) : Y; (L = w(D, X, L, h)) > -1;) D !== o && Qs.call(D, L, 1), Qs.call(o, L, 1);
                return o;
            }
            function qy(o, u) {
            ...
            var Gy = Js
                ...
                RT = Ys
                    ? function (o, u) {
                        return Ys(o, "toString", { configurable: !0, enumerable: !1, value: op(u), writable: !0 });
                    }
                    : fn;
            function PT(o) {
                return ga(ul(o));
            ...
            function Md(o, u, c) {
                ...
                for (var w = -1, _ = H(h); ++w < h;) for (var R = o[w], D = -1; ++D < h;) D != w && (_[w] = gu(_[w] || R, o[D], u, c));
            ...
            function o0(o, u) {
                return function (c, h) {
                    ...
                    for (var w = c.length, _ = u ? w : -1, R = Je(c); (u ? _-- : ++_ < w) && h(R[_], _, R) !== !1;);
                    return c;
                };
            }
            function l0(o) {
            ...
            function Yr(o, u, c, h, w, _, R, D) {
                ...
                if ((le && iI(fe, le), (o = fe[0]), (u = fe[1]), (c = fe[2]), (h = fe[3]), (w = fe[4]), (D = fe[9] = fe[9] === n ? (L ? 0 : o.length) : Ot(fe[9] - Y, 0)), !D && u & (k | P) && (u &= ~(k | P)), !u || u == A))
                    var ve = BT(o, u, c);
            ...
            var Vd = yd
                ...
                v0 = yd
                    ...
                    : ap,
                Wt = Jt;
            ((wd && Wt(new wd(new ArrayBuffer(1))) != re) || (cu && Wt(new cu()) != yt) || (xd && Wt(xd.resolve()) != Mt) || (el && Wt(new el()) != Ht) || (fu && Wt(new fu()) != Tr)) &&
                (Wt = function (o) {
                    var u = Jt(o),
...
`
            ...
            function vR() {
                ...
                if (o instanceof Me) {
                    var u = o;
                    return this.__actions__.length && (u = new Me(this)), (u = u.reverse()), u.__actions__.push({ func: ma, args: [Yd], thisArg: n }), new Yn(u, this.__chain__);
                }
                return this.thru(Yd);
            }
            function yR() {
            ...
            function XR(o, u, c) {
                var h = !0,
                    w = !0;
                if (typeof o != "function") throw new Qn(s);
                return ht(c) && ((h = "leading" in c ? !!c.leading : h), (w = "trailing" in c ? !!c.trailing : w)), j0(o, u, { leading: h, maxWait: u, trailing: w });
            }
            function ZR(o) {
                return z0(o, 1);
            }
            ...
            function a2(o, u, c) {
                if (
                    (c && typeof c != "boolean" && en(o, u, c) && (u = c = n),
                        c === n && (typeof u == "boolean" ? ((c = u), (u = n)) : typeof o == "boolean" && ((c = o), (o = n))),
                        o === n && u === n ? ((o = 0), (u = 1)) : ((o = ei(o)), u === n ? ((u = o), (o = 0)) : (u = ei(u))),
                        o > u)
                ) {
                    var h = o;
                    (o = u), (u = h);
            ...
            function k2(o, u, c) {
                return (
                    ...
                    (c = c === n ? ne : c >>> 0),
                    c ? ((o = qe(o)), o && (typeof u == "string" || (u != null && !tp(u))) && ((u = Tn(u)), !u && Yo(o)) ? _i(hr(o), 0, c) : o.split(u, c)) : []
                );
            }
            ...
            function O2(o, u, c) {
                ...
                var w = Ca({}, u.imports, h.imports, h0),
                    ...
                    fe =
                        "//# sourceURL=" +
                        (Ke.call(u, "sourceURL") ? (u.sourceURL + "").replace(/\s/g, " ") : "lodash.templateSources[" + ++Lb + "]") +
                        `
`;
                        ...
                        (o[D] = L),
                            ...
                            (o.prototype[D] = function () {
                                ...
                                if (_ || Y) {
                                    ...
                                    return ee.push({ func: L, args: arguments, thisArg: o }), (X.__chain__ = Y), X;
                                }
            ...
            return (
                ...
                Kn(["drop", "take"], function (o, u) {
                    (Me.prototype[o] = function (c) {
                        ...
                        return h.__filtered__ ? (h.__takeCount__ = jt(c, h.__takeCount__)) : h.__views__.push({ size: jt(c, ne), type: o + (h.__dir__ < 0 ? "Right" : "") }), h;
                    }),
                ...
                Kn(["filter", "map", "takeWhile"], function (o, u) {
                    ...
                    Me.prototype[o] = function (w) {
                        var _ = this.clone();
                        return _.__iteratees__.push({ iteratee: ge(w, 3), type: c }), (_.__filtered__ = _.__filtered__ || h), _;
                    };
                }),
...
var lk = jc.exports;
const dt = { water: { name: "water", close: !1, label: "VODA", stack: !0, usable: !0, count: 0 }, burger: { name: "burger", close: !1, label: "BURGR", stack: !1, usable: !1, count: 0 } };
let sc = "images";
function D3(e) {
    e && e !== "" && (sc = e);
}
...
async function ur(e, t) {
    if (!uk())
        try {
            return await (await fetch(`https://${N3}/${e}`, { method: "post", headers: { "Content-Type": "application/json; charset=UTF-8" }, body: JSON.stringify(t) })).json();
        } catch (n) {
...
const Ww = (e, t) => {
    ...
    Wf = (e, t, n) => ({ sourceInventory: t === Yt.PLAYER ? e.leftInventory : e.rightInventory, targetInventory: n ? (n === Yt.PLAYER ? e.leftInventory : e.rightInventory) : t === Yt.PLAYER ? e.rightInventory : e.leftInventory }),
    Gl = (e, t) => {
    ...
    $3 = (e, t) => {
        ...
        if (t.payload.slotsData) {
            const { inventoryId: n } = t.payload.slotsData,
                ...
                i = n === e.leftInventory.id ? "leftInventory" : n === e.rightInventory.id ? "rightInventory" : null;
            if (!i) return;
            (e[i].slots = r), iv.caseReducers.setupInventory(e, { type: "setupInventory", payload: { leftInventory: i === "leftInventory" ? e[i] : void 0, rightInventory: i === "rightInventory" ? e[i] : void 0 } });
        }
    },
    B3 = (e, t) => {
    ...
    U3 = (e, t) => {
        const { fromSlot: n, fromType: r, toSlot: i, toType: l, count: s } = t.payload,
            ...
            d = n.weight / n.count;
        (f.items[i.slot - 1] = { ...f.items[i.slot - 1], count: i.count + s, weight: d * (i.count + s) }),
            !(r === Yt.SHOP || r === Yt.CRAFTING) && (a.items[n.slot - 1] = n.count - s > 0 ? { ...a.items[n.slot - 1], count: n.count - s, weight: d * (n.count - s) } : { slot: n.slot });
    },
    H3 = (e, t) => {
        const { fromSlot: n, fromType: r, toSlot: i, toType: l, count: s } = t.payload,
            { sourceInventory: a, targetInventory: f } = Wf(e, r, l),
            ...
            g = a.items[n.slot - 1];
        (f.items[i.slot - 1] = { ...g, count: s, weight: d * s, slot: i.slot, durability: Gl(g.metadata, p) }),
            !(r === Yt.SHOP || r === Yt.CRAFTING) && (a.items[n.slot - 1] = n.count - s > 0 ? { ...a.items[n.slot - 1], count: n.count - s, weight: d * (n.count - s) } : { slot: n.slot });
    },
    j3 = { leftInventory: { id: "", type: "", slots: 0, maxWeight: 0, items: [] }, rightInventory: { id: "", type: "", slots: 0, maxWeight: 0, items: [] }, additionalMetadata: new Array(), itemAmount: 0, shiftPressed: !1, isBusy: !1 },
    iv = Zm({
        name: "inventory",
        initialState: j3,
        reducers: {
        ...
        extraReducers: (e) => {
            e.addMatcher(rk, (t) => {
                (t.isBusy = !0), (t.history = { leftInventory: vg(t.leftInventory), rightInventory: vg(t.rightInventory) });
            }),
                e.addMatcher(ok, (t) => {
                    t.isBusy = !1;
                }),
    ...
    { setAdditionalMetadata: W3, setItemAmount: V3, setShiftPressed: q3, setupInventory: ak, swapSlots: G3, moveSlots: K3, stackSlots: Q3, refreshSlots: Y3, setContainerWeight: X3 } = iv.actions,
...
const k4 = async (e, t, n) => {
    ...
    for (let S = 0; S < a.length; S++) {
        const { name: A, fn: y } = a[S],
            { x, y: k, data: P, reset: N } = await y({ x: p, y: g, initialPlacement: r, placement: v, strategy: i, middlewareData: m, rects: d, platform: s, elements: { reference: e, floating: t } });
        (p = x ?? p),
            (g = k ?? g),
            (m = { ...m, [A]: { ...m[A], ...P } }),
            N &&
            E <= 50 &&
            (E++, typeof N == "object" && (N.placement && (v = N.placement), N.rects && (d = N.rects === !0 ? await s.getElementRects({ reference: e, floating: t, strategy: i }) : N.rects), ({ x: p, y: g } = Qw(d, v, f))), (S = -1));
    }
...
async function kk(e, t) {
    ...
    const { x: r, y: i, platform: l, rects: s, elements: a, strategy: f } = e,
        { boundary: d = "clippingAncestors", rootBoundary: p = "viewport", elementContext: g = "floating", altBoundary: v = !1, padding: m = 0 } = Vf(t, e),
        E = C4(m),
        ...
        x = g === "floating" ? { x: r, y: i, width: s.floating.width, height: s.floating.height } : s.reference,
        k = await (l.getOffsetParent == null ? void 0 : l.getOffsetParent(a.floating)),
        P = (await (l.isElement == null ? void 0 : l.isElement(k))) ? (await (l.getScale == null ? void 0 : l.getScale(k))) || { x: 1, y: 1 } : { x: 1, y: 1 },
        N = Kc(l.convertOffsetParentRelativeRectToViewportRelativeRect ? await l.convertOffsetParentRelativeRectToViewportRelativeRect({ elements: a, rect: x, offsetParent: k, strategy: f }) : x);
    return { top: (y.top - N.top + E.top) / P.y, bottom: (N.bottom - y.bottom + E.bottom) / P.y, left: (y.left - N.left + E.left) / P.x, right: (N.right - y.right + E.right) / P.x };
}
const _4 = function (e) {
    return (
        e === void 0 && (e = {}),
        {
            ...
            async fn(t) {
                var n, r;
                const { placement: i, middlewareData: l, rects: s, initialPlacement: a, platform: f, elements: d } = t,
                    { mainAxis: p = !0, crossAxis: g = !0, fallbackPlacements: v, fallbackStrategy: m = "bestFit", fallbackAxisSideDirection: E = "none", flipAlignment: S = !0, ...A } = Vf(e, t);
...
async function b4(e, t) {
    const { placement: n, platform: r, elements: i } = e,
        ...
        p = l && f ? -1 : 1,
        g = Vf(t, e);
    let { mainAxis: v, crossAxis: m, alignmentAxis: E } = typeof g == "number" ? { mainAxis: g, crossAxis: 0, alignmentAxis: null } : { mainAxis: 0, crossAxis: 0, alignmentAxis: null, ...g };
    return a && typeof E == "number" && (m = a === "end" ? E * -1 : E), f ? { x: m * p, y: v * d } : { x: v * d, y: m * p };
}
const O4 = function (e) {
    return (
        e === void 0 && (e = 0),
        {
            ...
            async fn(t) {
                ...
                const { x: i, y: l, placement: s, middlewareData: a } = t,
                    f = await b4(t, e);
                return s === ((n = a.offset) == null ? void 0 : n.placement) && (r = a.arrow) != null && r.alignmentOffset ? {} : { x: i + f.x, y: l + f.y, data: { ...f, placement: s } };
            },
        }
    );
},
...
function Kf(e) {
    return Ur(e) ? { scrollLeft: e.scrollLeft, scrollTop: e.scrollTop } : { scrollLeft: e.pageXOffset, scrollTop: e.pageYOffset };
}
function ro(e) {
...
function Tk(e) {
    const t = zn(e);
    return !av() || !t.visualViewport ? P4 : { x: t.visualViewport.offsetLeft, y: t.visualViewport.offsetTop };
}
function A4(e, t, n) {
...
function N4(e) {
    ...
    return { width: n.width * d.x, height: n.height * d.y, x: n.x * d.x - f.scrollLeft * d.x + p.x, y: n.y * d.y - f.scrollTop * d.y + p.y };
}
function M4(e) {
...
function L4(e) {
    ...
    const a = -n.scrollTop;
    return br(r).direction === "rtl" && (s += Ao(t.clientWidth, r.clientWidth) - i), { width: i, height: l, x: s, y: a };
}
function F4(e, t) {
    const n = zn(e),
        r = mi(e),
...
const j4 = async function (e) {
    ...
    return { reference: H4(e.reference, await t(e.floating), e.strategy), floating: { x: 0, y: 0, width: r.width, height: r.height } };
};
function W4(e) {
    return br(e).direction === "rtl";
}
const V4 = { convertOffsetParentRelativeRectToViewportRelativeRect: N4, getDocumentElement: mi, getClippingRect: B4, getOffsetParent: Pk, getElementRects: j4, getClientRects: M4, getDimensions: U4, getScale: Ml, isElement: Ur, isRTL: W4 };
function q4(e, t) {
    let n = null,
        r;
    const i = mi(e);
    ...
    function s(a, f) {
        ...
        const m = Ha(p),
            ...
            A = Ha(d),
            x = { rootMargin: -m + "px " + -E + "px " + -S + "px " + -A + "px", threshold: Ao(0, Vc(1, f)) || 1 };
        let k = !0;
        function P(N) {
...
function G4(e, t, n, r) {
    r === void 0 && (r = {});
    const { ancestorScroll: i = !0, ancestorResize: l = !0, elementResize: s = typeof ResizeObserver == "function", layoutShift: a = typeof IntersectionObserver == "function", animationFrame: f = !1 } = r,
        d = cv(e),
        p = i || l ? [...(d ? Yi(d) : []), ...Yi(t)] : [];
    p.forEach((y) => {
...
function Q4(e) {
    e === void 0 && (e = {});
    const { placement: t = "bottom", strategy: n = "absolute", middleware: r = [], platform: i, elements: { reference: l, floating: s } = {}, transform: a = !0, whileElementsMounted: f, open: d } = e,
        [p, g] = I.useState({ x: 0, y: 0, strategy: n, placement: t, middlewareData: {}, isPositioned: !1 }),
        [v, m] = I.useState(r);
    Qc(v, r) || m(r);
    ...
    ac(() => {
        d === !1 && z.current.isPositioned && ((z.current.isPositioned = !1), g((oe) => ({ ...oe, isPositioned: !1 })));
    }, [d]);
    const B = I.useRef(!1);
    ac(
        () => (
    ...
    const U = I.useMemo(() => ({ reference: T, floating: F, setReference: x, setFloating: k }), [x, k]),
        ...
        ue = I.useMemo(() => {
            ...
            const j = Jw(Z.floating, p.x),
                J = Jw(Z.floating, p.y);
            return a ? { ...oe, transform: "translate(" + j + "px, " + J + "px)", ...(Mk(Z.floating) >= 1.5 && { willChange: "transform" }) } : { position: n, left: j, top: J };
        }, [n, a, Z.floating, p.x, p.y]);
    return I.useMemo(() => ({ ...p, update: G, refs: U, elements: Z, floatingStyles: ue }), [p, G, U, Z, ue]);
}
/*!
 * tabbable 6.2.0
 ...
 */ var Y4 = [
    ...
    pz = function e(t) {
        ...
        return (
            t.forEach(function (i, l) {
                ...
                f === 0 ? (s ? n.push.apply(n, d) : n.push(a)) : r.push({ documentOrder: l, tabIndex: f, item: i, isScope: s, content: d });
            }),
            r
                .sort(tz)
                .reduce(function (i, l) {
    ...
    dv = function (t, n) {
        n = n || {};
        var r;
        return n.getShadowRoot ? (r = J4([t], n.includeContainer, { filter: nx.bind(null, n), flatten: !1, getShadowRoot: n.getShadowRoot, shadowRootFilter: dz })) : (r = Z4(t, n.includeContainer, nx.bind(null, n))), pz(r);
    };
function pv(e) {
    return I.useMemo(
        () =>
...
function Kt(e, t) {
    let { startingIndex: n = -1, decrement: r = !1, disabledIndices: i, amount: l = 1 } = t === void 0 ? {} : t;
    const s = e.current;
    let a = n;
    do {
        var f, d;
...
function hz(e, t) {
    let { event: n, orientation: r, loop: i, cols: l, disabledIndices: s, minIndex: a, maxIndex: f, prevIndex: d, stopEvent: p = !1 } = t,
        g = d;
    if (n.key === hv) {
        if ((p && $t(n), d === -1)) g = f;
        else if (((g = Kt(e, { startingIndex: g, amount: l, decrement: !0, disabledIndices: s })), i && (d - l < a || g < 0))) {
            const v = d % l,
                m = f % l,
                E = f - (m - v);
            m === v ? (g = f) : (g = m > v ? E : E - l);
    ...
    if (
        (n.key === Qf &&
            (p && $t(n), d === -1 ? (g = a) : ((g = Kt(e, { startingIndex: d, amount: l, disabledIndices: s })), i && d + l > f && (g = Kt(e, { startingIndex: (d % l) - l, amount: l, disabledIndices: s }))), Ju(e, g) && (g = d)),
            r === "both")
    ) {
        const v = Gw(d / l);
        n.key === As &&
            (p && $t(n),
                d % l !== l - 1
                    ? ((g = Kt(e, { startingIndex: d, disabledIndices: s })), i && ja(g, l, v) && (g = Kt(e, { startingIndex: d - (d % l) - 1, disabledIndices: s })))
                    : i && (g = Kt(e, { startingIndex: d - (d % l) - 1, disabledIndices: s })),
                ja(g, l, v) && (g = d)),
            n.key === Yl &&
            (p && $t(n),
                d % l !== 0
                    ? ((g = Kt(e, { startingIndex: d, disabledIndices: s, decrement: !0 })), i && ja(g, l, v) && (g = Kt(e, { startingIndex: d + (l - (d % l)), decrement: !0, disabledIndices: s })))
                    : i && (g = Kt(e, { startingIndex: d + (l - (d % l)), decrement: !0, disabledIndices: s })),
                ja(g, l, v) && (g = d));
        const m = Gw(f / l) === v;
        Ju(e, g) && (i && m ? (g = n.key === Yl ? f : Kt(e, { startingIndex: d - (d % l) - 1, disabledIndices: s })) : (g = d));
    }
    return g;
}
let ix = 0;
...
const Bk = I.createContext({ register: () => { }, unregister: () => { }, map: new Map(), elementsRef: { current: [] } });
function vz(e) {
    ...
    return (
        ...
        I.createElement(Bk.Provider, { value: I.useMemo(() => ({ register: s, unregister: a, map: i, elementsRef: n, labelsRef: r }), [s, a, i, n, r]) }, t)
    );
}
function Uk(e) {
...
function Ez(e) {
    ...
    const r = Vo();
    return I.createElement(jk.Provider, { value: I.useMemo(() => ({ id: n, parentId: r }), [n, r]) }, t);
}
function Cz(e) {
    let { children: t } = e;
    const n = I.useRef([]),
        ...
        l = I.useState(() => Hk())[0];
    return I.createElement(Wk.Provider, { value: I.useMemo(() => ({ nodesRef: n, addNode: r, removeNode: i, events: l }), [n, r, i, l]) }, t);
}
function Xl(e) {
...
function kz(e, t) {
    ...
    const {
        ...
        { enabled: d = !0, delay: p = 0, handleClose: g = null, mouseOnly: v = !1, restMs: m = 0, move: E = !0 } = t,
        S = so(),
        A = Vo(),
        y = vn(g),
        x = vn(p),
        ...
        I.useMemo(() => {
            ...
            return {
                ...
                floating: {
                    ...
                    onMouseLeave(Z) {
                        l.emit("dismiss", { type: "mouseLeave", data: { returnFocus: !1 } }), $(Z.nativeEvent, !1);
                    },
                },
            };
        }, [l, d, m, n, r, $])
...
const gv = () => ({ getShadowRoot: !0, displayCheck: typeof ResizeObserver == "function" && ResizeObserver.toString().includes("[native code]") ? "full" : "none" });
function qk(e, t) {
    const n = dv(e, gv());
    t === "prev" && n.reverse();
...
const mv = { border: 0, clip: "rect(0 0 0 0)", height: "1px", margin: "-1px", overflow: "hidden", padding: 0, position: "fixed", whiteSpace: "nowrap", width: "1px", top: 0, left: 0 };
let Az;
function sx(e) {
...
const Zc = I.forwardRef(function (t, n) {
    ...
    const l = { ref: n, tabIndex: 0, role: r, "aria-hidden": r ? void 0 : !0, [Xl("focus-guard")]: "", style: mv };
...
function vv(e) {
    ...
    return (
        ...
        I.createElement(
            Qk.Provider,
            { value: I.useMemo(() => ({ preserveTabOrder: i, beforeOutsideRef: f, afterOutsideRef: d, beforeInsideRef: p, afterInsideRef: g, portalNode: l, setFocusManagerState: a }), [i, l]) },
            v &&
            l &&
            I.createElement(Zc, {
                "data-type": "outside",
...
const Yk = () => I.useContext(Qk),
    Nz = I.forwardRef(function (t, n) {
        return I.createElement("button", ks({}, t, { type: "button", ref: n, tabIndex: -1, style: mv }));
    });
function Xk(e) {
    const { context: t, children: n, disabled: r = !1, order: i = ["content"], guards: l = !0, initialFocus: s = 0, returnFocus: a = !0, modal: f = !0, visuallyHiddenDismiss: d = !1, closeOnFocusOut: p = !0 } = e,
        {
            open: g,
            refs: v,
            nodeId: m,
            ...
            return (
                ...
                () => {
                    ...
                    (Pt(x, me) ||
                        ...
                        T.current && Kl(B.current) && !G.current && ri(B.current, { cancelPrevious: !1, preventScroll: ne });
                }
            );
        }, [r, x, T, A, v, S, F, m]),
        Qe(() => {
            if (!(r || !z))
                return (
                    z.setFocusManagerState({ modal: f, closeOnFocusOut: p, open: g, onOpenChange: E, refs: v }),
                    () => {
    ...
    function J(ne) {
        return r || !d || !f ? null : I.createElement(Nz, { ref: ne === "start" ? Q : $, onClick: (ae) => E(!1, ae.nativeEvent) }, typeof d == "string" ? d : "Dismiss");
    }
    const b = !r && k && !ue && (Z || f);
        ...
        return (
            Qe(() => {
                ...
                if (((a.overflow = "hidden"), p && (a[d] = p + "px"), s)) {
                    ...
                    Object.assign(a, { position: "fixed", top: -(v - Math.floor(A)) + "px", left: -(g - Math.floor(S)) + "px", right: "0" });
                }
                return () => {
                    th.delete(l), th.size === 0 && (Object.assign(a, { overflow: "", [d]: "" }), s && (Object.assign(a, { position: "", top: "", left: "", right: "" }), window.scrollTo(g, v)));
                };
            }, [l, r]),
            I.createElement("div", ks({ ref: n }, i, { style: { position: "fixed", overflow: "auto", top: 0, right: 0, bottom: 0, left: 0, ...i.style } }))
        );
    });
function ax(e) {
...
function Mz(e, t) {
    ...
    const {
        ...
        { enabled: s = !0, event: a = "click", toggle: f = !0, ignoreMouse: d = !1, keyboardHandlers: p = !0 } = t,
        g = I.useRef(),
        v = I.useRef(!1);
    return I.useMemo(
        () =>
            s
                ? {
                    reference: {
                        ...
                        onMouseDown(m) {
                            m.button === 0 &&
                                ((Wc(g.current, !0) && d) || (a !== "click" && (n && f && (!i.current.openEvent || i.current.openEvent.type === "mousedown") ? r(!1, m.nativeEvent) : (m.preventDefault(), r(!0, m.nativeEvent)))));
                        },
                        onClick(m) {
...
const zz = { pointerdown: "onPointerDown", mousedown: "onMouseDown", click: "onClick" },
    $z = { pointerdown: "onPointerDownCapture", mousedown: "onMouseDownCapture", click: "onClickCapture" },
    Bz = (e) => {
        var t, n;
        return { escapeKeyBubbles: typeof e == "boolean" ? e : (t = e?.escapeKey) != null ? t : !1, outsidePressBubbles: typeof e == "boolean" ? e : (n = e?.outsidePress) != null ? n : !0 };
    };
function Jk(e, t) {
    t === void 0 && (t = {});
    const {
        ...
        { enabled: p = !0, escapeKey: g = !0, outsidePress: v = !0, outsidePressEvent: m = "pointerdown", referencePress: E = !1, referencePressEvent: S = "pointerdown", ancestorScroll: A = !1, bubbles: y } = t,
        x = so(),
        k = Vo() != null,
        ...
        q = Xi(($) => {
            ...
            i.emit("dismiss", { type: "escapeKey", data: { returnFocus: { preventScroll: !1 } } }), r(!1, p4($) ? $.nativeEvent : $);
        }),
        Q = Xi(($) => {
            const G = T.current;
            ...
            i.emit("dismiss", { type: "outsidePress", data: { returnFocus: k ? { preventScroll: !0 } : vk($) || yk($) } }), r(!1, $);
        });
    return (
        I.useEffect(() => {
            if (!n || !p) return;
            ...
            let B = [];
            return (
                A && (hn(a) && (B = Yi(a)), hn(f) && (B = B.concat(Yi(f))), !hn(s) && s && s.contextElement && (B = B.concat(Yi(s.contextElement)))),
                (B = B.filter((U) => {
                    var Z;
                ...
                p
                    ? {
                        reference: {
                            onKeyDown: q,
                            [zz[S]]: ($) => {
                                E && (i.emit("dismiss", { type: "referencePress", data: { returnFocus: !1 } }), r(!1, $.nativeEvent));
                            },
                        },
                        floating: {
                            onKeyDown: q,
...
function yv(e) {
    ...
    const { open: n = !1, onOpenChange: r, nodeId: i } = e,
        ...
        S = I.useCallback(
            (P) => {
                const N = hn(P) ? { getBoundingClientRect: () => P.getBoundingClientRect(), contextElement: P } : P;
        ...
        y = I.useMemo(() => ({ ...f.refs, setReference: A, setPositionReference: S, domReference: g }), [f.refs, A, S]),
        x = I.useMemo(() => ({ ...f.elements, domReference: a }), [f.elements, a]),
        k = I.useMemo(() => ({ ...f, refs: y, elements: x, dataRef: v, nodeId: i, floatingId: E, events: m, open: n, onOpenChange: p }), [f, i, E, m, n, p, y, x]);
    return (
        Qe(() => {
...
function e_(e) {
    ...
    return I.useMemo(() => ({ getReferenceProps: n, getFloatingProps: r, getItemProps: i }), [n, r, i]);
}
let fx = !1;
function Yf(e, t, n) {
    switch (e) {
...
function Hz(e, t) {
    const {
        ...
        Ae = Xi(function (Te, Be, Fe) {
            ...
            Ge &&
                (A ? (de(Ge.id), Q?.events.emit("virtualfocus", Ge), z && (z.current = Ge)) : ri(Ge, { preventScroll: !0, sync: d4() && wk() ? fx || j.current : !1 }),
                    requestAnimationFrame(() => {
                        const yt = ae.current;
                        yt && Ge && (Fe || !Z.current) && (Ge.scrollIntoView == null || Ge.scrollIntoView(typeof yt == "boolean" ? { block: "nearest", inline: "nearest" } : yt));
                    }));
        });
    Qe(() => {
                    ...
                    if ((oe.current && ((B.current = -1), Ae(a, B)), !oe.current && G.current && (U.current != null || (G.current === !0 && U.current == null)))) {
                        ...
                        const Be = () => {
                            a.current[0] == null
                                ...
                                : ((B.current = U.current == null || rh(U.current, N, S) || E ? Xp(a, b.current) : rx(a, b.current)), (U.current = null), $(B.current));
                        };
                        Be();
                    }
            ...
            return {
                ...
                ...(x && {
                    ...
                    onPointerLeave(Fe) {
                        ...
                        !Z.current || Ge === "touch" || ((B.current = -1), Ae(a, B), $(null), A || ri(i.floating.current, { preventScroll: !0 }));
                    },
                }),
            };
        }, [n, i, Ae, x, a, $, A]);
        ...
        function Be(he) {
            ...
            if (
                (he.key === "Home" && ($t(he), (B.current = Mt), $(B.current)),
                    ...
                    !(T > 1 && ((B.current = hz(a, { event: he, orientation: N, loop: m, cols: T, disabledIndices: Te, minIndex: Mt, maxIndex: Cn, prevIndex: B.current, stopEvent: !0 })), $(B.current), N === "both")) && dx(he.key, N))
            ) {
                ...
                rh(he.key, N, S)
                    ? m
                        ? (B.current = at >= Cn ? (v && at !== a.current.length ? -1 : Mt) : Kt(a, { startingIndex: at, disabledIndices: Te }))
                        : (B.current = Math.min(Cn, Kt(a, { startingIndex: at, disabledIndices: Te })))
                    : m
                        ? (B.current = at <= Mt ? (v && at !== -1 ? a.current.length : Cn) : Kt(a, { startingIndex: at, decrement: !0, disabledIndices: Te }))
                        : (B.current = Math.max(Mt, Kt(a, { startingIndex: at, decrement: !0, disabledIndices: Te }))),
    ...
    return I.useMemo(() => {
        ...
        return i
            ? l === "tooltip"
                ...
                : {
                    reference: { "aria-expanded": n ? "true" : "false", "aria-haspopup": l === "alertdialog" ? "dialog" : l, "aria-controls": n ? r : void 0, ...(l === "listbox" && { role: "combobox" }), ...(l === "menu" && { id: s }) },
...
function wv(e, t) {
    ...
    return (
        Qe(() => {
            ...
            if (
                (A === "initial" && E((q) => ({ transitionProperty: q.transitionProperty, ...F, ...N })), A === "open" && E({ transitionProperty: Object.keys(z).map(hx).join(","), transitionDuration: g + "ms", ...F, ...z }), A === "close")
            ) {
                const q = T || N;
                E({ transitionProperty: Object.keys(q).map(hx).join(","), transitionDuration: v + "ms", ...F, ...q });
            }
        }, [v, k, y, x, P, g, A, d]),
...
function qz(e, t) {
    ...
    const { open: r, dataRef: i } = e,
        { listRef: l, activeIndex: s, onMatch: a, onTypingChange: f, enabled: d = !0, findMatch: p = null, resetMs: g = 750, ignoreKeys: v = [], selectedIndex: m = null } = t,
        E = I.useRef(),
        S = I.useRef(""),
...
const Qz = ({ infoVisible: e, setInfoVisible: t }) => {
                            ...
                            children: [
                                ...
                                we("div", {
                                    ...
                                    children: [
                                        ...
                                        we("p", { children: [W("kbd", { children: "ALT + LMB" }), W("br", {}), ut.ui_alt_lmb] }),
                                        we("p", { children: [W("kbd", { children: "CTRL + LMB" }), W("br", {}), ut.ui_ctrl_lmb] }),
                                        we("p", { children: [W("kbd", { children: "SHIFT + Drag" }), W("br", {}), ut.ui_shift_drag] }),
                                        we("p", { children: [W("kbd", { children: "CTRL + SHIFT + LMB" }), W("br", {}), ut.ui_ctrl_shift_lmb] }),
    ...
    Yz = () => {
        ...
        return we(En, {
            children: [
                W(Qz, { infoVisible: n, setInfoVisible: r }),
                W("div", {
                    ...
                    children: we("div", {
                        ...
                        children: [
                            ...
                            W("button", { className: "inventory-control-button", ref: i, children: ut.ui_use || "Use" }),
                            W("button", { className: "inventory-control-button", ref: l, children: ut.ui_give || "Give" }),
                            W("button", { className: "inventory-control-button", onClick: () => ur("exit"), children: ut.ui_close || "Close" }),
                        ],
                    }),
                }),
                W("button", {
    ...
    xv = ({ percent: e, durability: t }) => {
        const n = I.useMemo(
            () => (t ? (e < 50 ? qa(Ti.accentColor, Ti.primaryColor, e / 100) : qa(Ti.secondColor, Ti.accentColor, e / 100)) : e > 50 ? qa(Ti.primaryColor, Ti.accentColor, e / 100) : qa(Ti.accentColor, Ti.secondColor, e / 50)),
            [t, e]
        );
        return W("div", {
            className: t ? "durability-bar" : "weight-bar",
            children: W("div", { style: { visibility: e > 0 ? "visible" : "hidden", height: "100%", width: `${e}%`, backgroundColor: n, transition: `background ${0.3}s ease, width ${0.3}s ease` } }),
        });
    };
function Cg(e, t) {
    return (
    ...
    vi = (function (e) {
        ...
        function t(r, i) {
            ...
            var s = i,
                ...
                f;
            return (l.appearStatus = null), r.in ? (a ? ((f = Co), (l.appearStatus = ko)) : (f = pl)) : r.unmountOnExit || r.mountOnEnter ? (f = $u) : (f = Co), (l.state = { status: f }), (l.nextCallback = null), l;
        }
        ...
        return (
            ...
            (n.getTimeouts = function () {
                var i = this.props.timeout,
                    ...
                    s,
                    a;
                return (l = s = a = i), i != null && typeof i != "number" && ((l = i.exit), (s = i.enter), (a = i.appear !== void 0 ? i.appear : s)), { exit: l, enter: s, appear: a };
            }),
            ...
            (n.render = function () {
                ...
                return Ve.createElement(Jc.Provider, { value: null }, typeof s == "function" ? s(i, a) : Ve.cloneElement(Ve.Children.only(s), a));
            }),
            t
        );
    })(Ve.Component);
...
vi.propTypes = {};
function dl() { }
vi.defaultProps = { in: !1, mountOnEnter: !1, unmountOnExit: !1, appear: !1, enter: !0, exit: !0, onEnter: dl, onEntering: dl, onEntered: dl, onExit: dl, onExiting: dl, onExited: dl };
vi.UNMOUNTED = $u;
vi.EXITED = Co;
vi.ENTERING = ko;
vi.ENTERED = pl;
    ...
    Ev = (function (e) {
        ...
        return (
            ...
            (n.render = function () {
                ...
                return Ve.createElement(o6, Lc({}, l, { onEnter: this.onEnter, onEntered: this.onEntered, onEntering: this.onEntering, onExit: this.onExit, onExiting: this.onExiting, onExited: this.onExited }));
            }),
            t
        );
    })(Ve.Component);
...
function a6(e, t) {
    return Cv(e.children, function (n) {
        return I.cloneElement(n, { onExited: t.bind(null, n), in: !0, appear: Io(n, "appear", e), enter: Io(n, "enter", e), exit: Io(n, "exit", e) });
    });
}
function c6(e, t, n) {
    var r = Cv(e.children),
    ...
    return (
        Object.keys(i).forEach(function (l) {
            ...
            if (I.isValidElement(s)) {
                ...
                f && (!a || p)
                    ? (i[l] = I.cloneElement(s, { onExited: n.bind(null, s), in: !0, exit: Io(s, "exit", e), enter: Io(s, "enter", e) }))
                    : !f && a && !p
                        ? (i[l] = I.cloneElement(s, { in: !1 }))
                        : f && a && I.isValidElement(d) && (i[l] = I.cloneElement(s, { onExited: n.bind(null, s), in: d.props.in, exit: Io(s, "exit", e), enter: Io(s, "enter", e) }));
            }
        }),
        i
    );
    ...
    kv = (function (e) {
        ...
        return (
            ...
            (n.render = function () {
                ...
                return delete a.appear, delete a.enter, delete a.exit, l === null ? Ve.createElement(Jc.Provider, { value: f }, d) : Ve.createElement(Jc.Provider, { value: f }, Ve.createElement(l, a, d));
            }),
            t
        );
    })(Ve.Component);
...
const p6 = kv,
    h6 = (e) => {
        ...
        return W(o_, { nodeRef: t, in: e.in, timeout: 200, classNames: "transition-slide-up", unmountOnExit: !0, children: Ve.cloneElement(e.children, { ref: t }) });
    },
    g6 = () => {
                                ...
                                children:
                                    ...
                                    we("div", {
                                        ...
                                        children: [
                                                ...
                                                children: [
                                                    ...
                                                    we("div", {
                                                        ...
                                                        children: [
                                                            ...
                                                            W("p", { children: l.count ? l.count.toLocaleString("en-us") + "x" : "" }),
                                                        ],
                                                    }),
                                                ],
                                            }),
                                            we("div", {
                                                children: [
                                                    l?.durability !== void 0 && W(xv, { percent: l.durability, durability: !0 }),
                                                    W("div", {
                                                        className: "inventory-slot-label-box",
                                                        children: W("div", { className: "inventory-slot-label-text", children: l.metadata?.label ? l.metadata.label : dt[l.name]?.label || l.name }),
                                                    }),
                                                ],
                                            }),
                                        ],
    ...
    _g = (e, t) => {
        ...
        Nn.dispatch(y6({ ...d, fromSlot: l.slot, toSlot: a.slot })), gn(a, !0) ? (s.stack && M3(l, a) ? Nn.dispatch(Q3({ ...d, toSlot: a })) : Nn.dispatch(G3({ ...d, toSlot: a }))) : Nn.dispatch(K3(d));
    },
    ...
    C6 = ({ item: e, inventoryId: t, inventoryType: n, inventoryGroups: r }, i) => {
        const l = hi(),
            ...
            [{ isDragging: d }, p] = AF(
                () => ({
                    ...
                    item: () => (gn(e, n !== Yt.SHOP) ? { inventory: n, item: { name: e.name, slot: e.slot }, image: e?.name && `url(${Nl(e) || "none"}` } : null),
                    canDrag: f,
                }),
                [n, e]
            ),
        ...
        Lr("refreshSlots", (y) => {
            (!d && !y.items) || !Array.isArray(y.items) || !y.items.find((k) => k.item.slot === e.slot && k.inventory === t) || l.dispatch({ type: "dnd-core/END_DRAG" });
        });
        const m = (y) => p(v(y)),
            E = (y) => {
                y.preventDefault(), !(n !== "player" || !gn(e)) && s(o4({ item: e, coords: { x: y.clientX, y: y.clientY } }));
            },
            S = (y) => {
                s(Zu()), a.current && clearTimeout(a.current), y.ctrlKey && gn(e) && n !== "shop" && n !== "crafting" ? _g({ item: e, inventory: n }) : y.altKey && gn(e) && n === "player" && ov(e);
            },
            A = pv([m, i]);
        return W("div", {
            ref: A,
            ...
            style: {
                filter: !Ww(e, { type: n, groups: r }) || !Vw(e, n) ? "brightness(80%) grayscale(100%)" : void 0,
                opacity: d ? 0.4 : 1,
                ...
                we("div", {
                    ...
                    children: [
                        we("div", {
                            ...
                            children: [
                                n === "player" && e.slot <= 5 && W("div", { className: "inventory-slot-number", children: e.slot }),
                                we("div", {
                                    className: "item-slot-info-wrapper",
                                    children: [
                                        W("p", {
                                            children:
                                                e.weight > 0 ? (e.weight >= 1e3 ? `${(e.weight / 1e3).toLocaleString("en-us", { minimumFractionDigits: 2 })}kg ` : `${e.weight.toLocaleString("en-us", { minimumFractionDigits: 0 })}g `) : "",
                                        }),
                        ...
                        we("div", {
                            children: [
                                n !== "shop" && e?.durability !== void 0 && W(xv, { percent: e.durability, durability: !0 }),
                                n === "shop" &&
                                e?.price !== void 0 &&
                                W(En, {
                                    children:
                                        e?.currency !== "money" && e.currency !== "black_money" && e.price > 0 && e.currency
                                            ? we("div", {
                                            ...
                                            : W(En, {
                                                children:
                                                    ...
                                                    W("div", {
                                                        ...
                                                        style: { color: e.currency === "money" || !e.currency ? "#2ECC71" : "#E74C3C" },
                                                        children: we("p", { children: [ut.$ || "$", e.price.toLocaleString("en-us")] }),
                                                    }),
                                            }),
                                }),
                                W("div", { className: "inventory-slot-label-box", children: W("div", { className: "inventory-slot-label-text", children: e.metadata?.label ? e.metadata.label : dt[e.name]?.label || e.name }) }),
                            ],
                        }),
                    ],
                }),
            ...
            W(En, {
                children: we("div", {
                    ...
                    children: [
                        we("div", {
                            children: [
                                we("div", { className: "inventory-grid-header-wrapper", children: [W("p", { children: e.label }), e.maxWeight && we("p", { children: [t / 1e3, "/", e.maxWeight / 1e3, "kg"] })] }),
                        ...
                        W("div", {
                            ...
                            children: W(En, {
                                children: e.items
                                    .slice(0, (n + 1) * yx)
                                    .map((f, d) => W(k6, { item: f, ref: d === (n + 1) * yx - 1 ? l : null, inventoryType: e.type, inventoryGroups: e.groups, inventoryId: e.id }, `${e.type}-${e.id}-${f.slot}`)),
                            }),
                        }),
                    ],
                }),
...
class fr extends Error {
    constructor(t, n, r) {
        ...
        n && ("type" in n || "position" in n ? n.position && (l = n.position) : "start" in n || "end" in n ? (l = n) : ("line" in n || "column" in n) && (l.start = n)),
            (this.name = ts(n) || "1:1"),
...
class s_ {
    constructor(t) {
        let n;
        t ? (typeof t == "string" || B6(t) ? (n = { value: t }) : Og(t) ? (n = { path: t }) : (n = t)) : (n = {}),
            (this.data = {}),
            (this.messages = []),
            (this.history = []),
            (this.cwd = L6.cwd()),
...
var cc = Object.prototype.hasOwnProperty,
    ...
    Tx = function (t, n) {
        kx && n.name === "__proto__" ? kx(t, n.name, { enumerable: !0, configurable: !0, value: n.newValue, writable: !0 }) : (t[n.name] = n.newValue);
    },
    Ix = function (t, n) {
        if (n === "__proto__")
            if (cc.call(t, n)) {
        ...
        for (typeof a == "boolean" && ((p = a), (a = arguments[1] || {}), (f = 2)), (a == null || (typeof a != "object" && typeof a != "function")) && (a = {}); f < d; ++f)
            if (((t = arguments[f]), t != null))
                for (n in t)
                    (r = Ix(a, n)),
                        (i = Ix(t, n)),
                        a !== i && (p && i && (Ox(i) || (l = bx(i))) ? (l ? ((l = !1), (s = r && bx(r) ? r : [])) : (s = r && Ox(r) ? r : {}), Tx(a, { name: n, newValue: e(p, s, i) })) : typeof i < "u" && Tx(a, { name: n, newValue: i }));
        return a;
    };
const Rx = io(U6);
function Tg(e) {
...
function jr(e, t, n, r) {
    ...
    else for (n && e.splice(t, n); l < r.length;) (s = r.slice(l, l + 1e4)), s.unshift(t, 0), e.splice(...s), (l += 1e4), (t += 1e4);
}
function ir(e, t) {
...
function a5(e) {
    ...
    function E(k) {
        ...
        return (i = i || t.parser.flow(t.now())), e.enter("chunkFlow", { contentType: "flow", previous: l, _tokenizer: i }), S(k);
    }
    function S(k) {
        if (k === null) {
    ...
    function A(k, P) {
        ...
        if ((P && N.push(null), (k.previous = l), l && (l.next = k), (l = k), i.defineSkip(k.start), i.write(N), t.parser.lazy[k.start.line])) {
            ...
            for (; T--;) if (i.events[T][1].start.offset < s && (!i.events[T][1].end || i.events[T][1].end.offset > s)) return;
        ...
        if (e[n][0] === "enter" && e[n][1].type === "attentionSequence" && e[n][1]._close) {
            for (r = n; r--;)
                if (e[r][0] === "exit" && e[r][1].type === "attentionSequence" && e[r][1]._open && t.sliceSerialize(e[r][1]).charCodeAt(0) === t.sliceSerialize(e[n][1]).charCodeAt(0)) {
                    ...
                    zx(g, -f),
                        zx(v, f),
                        (s = { type: f > 1 ? "strongSequence" : "emphasisSequence", start: g, end: Object.assign({}, e[r][1].end) }),
                        (a = { type: f > 1 ? "strongSequence" : "emphasisSequence", start: Object.assign({}, e[n][1].start), end: v }),
                        (l = { type: f > 1 ? "strongText" : "emphasisText", start: Object.assign({}, e[r][1].end), end: Object.assign({}, e[n][1].start) }),
                        (i = { type: f > 1 ? "strong" : "emphasis", start: Object.assign({}, s.start), end: Object.assign({}, a.end) }),
...
function m5(e, t, n) {
    ...
    function i(s) {
        if (s === 62) {
            ...
            return a.open || (e.enter("blockQuote", { _container: !0 }), (a.open = !0)), e.enter("blockQuotePrefix"), e.enter("blockQuoteMarker"), e.consume(s), e.exit("blockQuoteMarker"), l;
        }
        return n(s);
    }
    function l(s) {
...
function x5(e, t, n) {
    ...
    function d(g) {
        return g === 88 || g === 120
            ? (e.enter("characterReferenceMarkerHexadecimal"), e.consume(g), e.exit("characterReferenceMarkerHexadecimal"), e.enter("characterReferenceValue"), (l = 6), (s = n5), p)
...
function S5(e, t, n) {
    ...
    function g(T) {
        return T === null || xe(T) ? (e.exit("codeFencedFence"), r.interrupt ? t(T) : e.check(Bx, S, P)(T)) : (e.enter("codeFencedFenceInfo"), e.enter("chunkString", { contentType: "string" }), v(T));
    }
    function v(T) {
    ...
    function m(T) {
        return T === null || xe(T) ? g(T) : (e.enter("codeFencedFenceMeta"), e.enter("chunkString", { contentType: "string" }), E(T));
    }
    function E(T) {
...
function O5(e) {
    ...
    for (r = n - 1, t++; ++r <= t;)
        i === void 0
            ...
            : (r === t || e[r][1].type === "lineEnding") && ((e[i][1].type = "codeTextData"), r !== i + 2 && ((e[i][1].end = e[r - 1][1].end), e.splice(i + 2, r - i - 2), (t -= r - i - 2), (r = i + 2)), (i = void 0));
    return e;
}
function T5(e) {
...
function m_(e) {
    ...
    for (; ++n < e.length;) {
        ...
        if (
            ((r = e[n]),
                n && r[1].type === "chunkFlow" && e[n - 1][1].type === "listItemPrefix" && ((f = r[1]._tokenizer.events), (l = 0), l < f.length && f[l][1].type === "lineEndingBlank" && (l += 2), l < f.length && f[l][1].type === "content"))
        )
...
function R5(e, t) {
    ...
    for (m = n; ++v < a.length;)
        a[v][0] === "exit" && a[v - 1][0] === "enter" && a[v][1].type === a[v - 1][1].type && a[v][1].start.line !== a[v][1].end.line && ((S = v + 1), A.push(S), (m._tokenizer = void 0), (m.previous = void 0), (m = m.next));
...
function N5(e, t) {
    ...
    function s(a) {
        return e.consume(a), e.exit("chunkContent"), (n.next = e.enter("chunkContent", { contentType: "content", previous: n })), (n = n.next), i;
    }
}
function M5(e, t, n) {
    const r = this;
...
function v_(e, t, n, r, i, l, s, a, f) {
    ...
    return g;
    function g(y) {
        return y === 60 ? (e.enter(r), e.enter(i), e.enter(l), e.consume(y), e.exit(l), v) : y === null || y === 32 || y === 41 || Ig(y) ? n(y) : (e.enter(r), e.enter(s), e.enter(a), e.enter("chunkString", { contentType: "string" }), S(y));
    }
    function v(y) {
        return y === 62 ? (e.enter(l), e.consume(y), e.exit(l), e.exit(i), e.exit(r), t) : (e.enter(a), e.enter("chunkString", { contentType: "string" }), m(y));
    }
    function m(y) {
...
function y_(e, t, n, r, i, l) {
    ...
    function p(m) {
        return a > 999 || m === null || m === 91 || (m === 93 && !f) || (m === 94 && !a && "_hiddenFootnoteSupport" in s.parser.constructs)
            ? n(m)
            : m === 93
...
function w_(e, t, n, r, i, l) {
    ...
    function d(v) {
        return v === s ? (e.exit(l), f(s)) : v === null ? n(v) : xe(v) ? (e.enter("lineEnding"), e.consume(v), e.exit("lineEnding"), rt(e, d, "linePrefix")) : (e.enter("chunkString", { contentType: "string" }), p(v));
    }
    function p(v) {
...
function o$(e, t) {
    ...
    const f = { type: e[l][1].type === "labelLink" ? "link" : "image", start: Object.assign({}, e[l][1].start), end: Object.assign({}, e[e.length - 1][1].end) },
        d = { type: "label", start: Object.assign({}, e[l][1].start), end: Object.assign({}, e[s][1].end) },
        p = { type: "labelText", start: Object.assign({}, e[l + r + 2][1].end), end: Object.assign({}, e[s - 2][1].start) };
    return (
        (a = [
            ["enter", f, t],
            ["enter", d, t],
...
function l$(e, t, n) {
    ...
    function a(v) {
        return l
            ? l._inactive
                ? g(v)
                : ((s = r.parser.defined.includes(Ll(r.sliceSerialize({ start: l.end, end: r.now() })))), e.enter("labelEnd"), e.enter("labelMarker"), e.consume(v), e.exit("labelMarker"), e.exit("labelEnd"), f)
            : n(v);
    }
    function f(v) {
...
function y$(e, t, n) {
    ...
    function a(m) {
        ...
        if (E === "listUnordered" ? !r.containerState.marker || m === r.containerState.marker : Rg(m)) {
            if ((r.containerState.type || ((r.containerState.type = E), e.enter(E, { _container: !0 })), E === "listUnordered")) return e.enter("listItemPrefix"), m === 42 || m === 45 ? e.check(fc, n, d)(m) : d(m);
...
function w$(e, t, n) {
    ...
    function l(a) {
        return r.containerState.furtherBlankLines || !We(a)
            ...
            : ((r.containerState.furtherBlankLines = void 0), (r.containerState.initialBlankLine = void 0), e.attempt(v$, t, s)(a));
    }
    function s(a) {
...
function C$(e, t) {
    ...
    const s = { type: "setextHeading", start: Object.assign({}, e[i][1].start), end: Object.assign({}, e[e.length - 1][1].end) };
        ...
        if ((n === e.length || e[n][1].type === "lineEnding") && e[n - 1][1].type === "data") {
            ...
            if (a) {
                const d = {
                    ...
                    start: { line: r.end.line, column: r.end.column - a, offset: r.end.offset - a, _index: r.start._index + l, _bufferIndex: l ? s : r.start._bufferIndex + s },
...
function P$(e, t, n) {
    ...
    let s = [],
        a = [];
    const f = { consume: x, enter: k, exit: P, attempt: F(N), check: F(T), interrupt: F(T, { interrupt: !0 }) },
        d = { previous: null, code: null, containerState: {}, events: [], parser: e, sliceStream: m, sliceSerialize: v, now: E, defineSkip: S, write: g };
    ...
    function A() {
        ...
        for (; r._index < s.length;) {
            const G = s[r._index];
            if (typeof G == "string") for ($ = r._index, r._bufferIndex < 0 && (r._bufferIndex = 0); r._index === $ && r._bufferIndex < G.length;) y(G.charCodeAt(r._bufferIndex));
            else y(G);
        }
    }
    function y($) {
    ...
    function x($) {
        xe($) ? (r.line++, (r.column = 1), (r.offset += $ === -3 ? 2 : 1), Q()) : $ !== -1 && (r.column++, r.offset++),
...
const N$ = { 42: dn, 43: dn, 45: dn, 48: dn, 49: dn, 50: dn, 51: dn, 52: dn, 53: dn, 54: dn, 55: dn, 56: dn, 57: dn, 62: p_ },
    M$ = { 91: L5 },
    L$ = { [-2]: dh, [-1]: dh, 32: dh },
    F$ = { 35: H5, 42: fc, 45: [jx, fc], 60: q5, 61: jx, 95: fc, 96: Ux, 126: Ux },
    z$ = { 38: g_, 92: h_ },
    $$ = { [-5]: ph, [-4]: ph, [-3]: ph, 33: c$, 38: g_, 42: Pg, 60: [p5, J5], 91: d$, 92: [B5, h_], 93: Ov, 95: Pg, 96: b5 },
    B$ = { null: [Pg, O$] },
    U$ = { null: [42, 95] },
    H$ = { null: [] },
    j$ = Object.freeze(
        Object.defineProperty({ __proto__: null, attentionMarkers: U$, contentInitial: M$, disable: H$, document: N$, flow: F$, flowInitial: L$, insideSpan: B$, string: z$, text: $$ }, Symbol.toStringTag, { value: "Module" })
    );
function W$(e) {
    const n = X6([j$, ...((e || {}).extensions || [])]),
        r = { defined: [], lazy: {}, constructs: n, content: i(l5), document: i(s5), flow: i(_$), string: i(T$), text: i(I$) };
    return r;
    function i(l) {
        return s;
        function s(a) {
    ...
    function i(l, s, a) {
        ...
        for (l = t + l.toString(s), g = 0, t = "", n && (l.charCodeAt(0) === 65279 && g++, (n = void 0)); g < l.length;) {
            ...
            if (m === 10 && g === v && r) f.push(-3), (r = void 0);
                ...
                switch ((r && (f.push(-5), (r = void 0)), g < v && (f.push(l.slice(g, v)), (e += v - g)), m)) {
                    case 0: {
                        f.push(65533), e++;
                        break;
                    }
...
function X$(e) {
    ...
    function r(V) {
        ...
        const pe = { stack: [re], tokenStack: [], config: t, enter: d, exit: g, buffer: f, resume: v, setData: l, getData: s },
            Ue = [];
        let He = -1;
        for (; ++He < V.length;)
        ...
        for (He = -1; ++He < V.length;) {
            const Zt = t[V[He][0]];
            C_.call(Zt, V[He][1].type) && Zt[V[He][1].type].call(Object.assign({ sliceSerialize: V[He][2].sliceSerialize }, pe), V[He][1]);
        }
        if (pe.tokenStack.length > 0) {
            const Zt = pe.tokenStack[pe.tokenStack.length - 1];
            (Zt[1] || Vx).call(pe, void 0, Zt[0]);
        }
        for (re.position = { start: Ii(V.length > 0 ? V[0][1].start : { line: 1, column: 1, offset: 0 }), end: Ii(V.length > 0 ? V[V.length - 2][1].end : { line: 1, column: 1, offset: 0 }) }, He = -1; ++He < t.transforms.length;)
    ...
    function i(V, re, pe) {
        ...
        for (; ++Ue <= pe;) {
            const it = V[Ue];
            if (
                (it[1].type === "listUnordered" || it[1].type === "listOrdered" || it[1].type === "blockQuote"
                    ? (it[0] === "enter" ? He++ : He--, (qr = void 0))
                    : it[1].type === "lineEndingBlank"
                        ? it[0] === "enter" && (qn && !qr && !He && !Vr && (Vr = Ue), (qr = void 0))
                        : it[1].type === "linePrefix" || it[1].type === "listItemValue" || it[1].type === "listItemMarker" || it[1].type === "listItemPrefix" || it[1].type === "listItemPrefixWhitespace" || (qr = void 0),
                    (!He && it[0] === "enter" && it[1].type === "listItemPrefix") || (He === -1 && it[0] === "exit" && (it[1].type === "listUnordered" || it[1].type === "listOrdered")))
            ) {
                if (qn) {
                    let uu = Ue;
                    for (_n = void 0; uu--;) {
                ...
                it[1].type === "listItemPrefix" && ((qn = { type: "listItem", _spread: !1, start: Object.assign({}, it[1].start), end: void 0 }), V.splice(Ue, 0, ["enter", qn, it[2]]), Ue++, pe++, (Vr = void 0), (qr = !0));
            }
        }
    ...
    function d(V, re, pe) {
        return this.stack[this.stack.length - 1].children.push(V), this.stack.push(V), this.tokenStack.push([re, pe]), (V.position = { start: Ii(re.start) }), V;
    }
    function p(V) {
        return re;
        function re(pe) {
    ...
    function g(V, re) {
        ...
        else throw new Error("Cannot close `" + V.type + "` (" + ts({ start: V.start, end: V.end }) + "): it’s not open");
    ...
    function $(V) {
        ...
        (!pe || pe.type !== "text") && ((pe = Tr()), (pe.position = { start: Ii(V.start) }), re.children.push(pe)), this.stack.push(pe);
    }
    function G(V) {
...
function Vx(e, t) {
    throw e
        ? new Error("Cannot close `" + e.type + "` (" + ts({ start: e.start, end: e.end }) + "): a different token (`" + t.type + "`, " + ts({ start: t.start, end: t.end }) + ") is open")
        : new Error("Cannot close document, a token (`" + t.type + "`, " + ts({ start: t.start, end: t.end }) + ") is still open");
}
function J$(e) {
    Object.assign(this, {
        Parser: (n) => {
            const r = this.data("settings");
            return Y$(n, Object.assign({}, r, e, { extensions: this.data("micromarkExtensions") || [], mdastExtensions: this.data("fromMarkdownExtensions") || [] }));
        },
    });
}
function eB(e, t) {
...
function __(e, t) {
    ...
    const s = e.footnoteCounts[n],
        a = {
            type: "element",
            tagName: "a",
            properties: { href: "#" + e.clobberPrefix + "fn-" + r, id: e.clobberPrefix + "fnref-" + r + (s > 1 ? "-" + s : ""), dataFootnoteRef: !0, ariaDescribedBy: ["footnote-label"] },
...
function oB(e, t) {
    ...
    for (; r in n;) r++;
    const i = String(r);
    return (n[i] = { type: "footnoteDefinition", identifier: i, children: [{ type: "paragraph", children: t.children }], position: t.position }), __(e, { type: "footnoteReference", identifier: i, position: t.position });
}
function lB(e, t) {
...
function pB(e, t, n) {
    ...
    if (typeof t.checked == "boolean") {
        const p = r[0];
        let g;
        p && p.type === "element" && p.tagName === "p" ? (g = p) : ((g = { type: "element", tagName: "p", properties: {}, children: [] }), r.unshift(g)),
            g.children.length > 0 && g.children.unshift({ type: "text", value: " " }),
            g.children.unshift({ type: "element", tagName: "input", properties: { type: "checkbox", checked: t.checked, disabled: !0 }, children: [] }),
    ...
    DB = function (e, t, n, r) {
        ...
        function s(a, f, d) {
            ...
            if (typeof p.type == "string") {
                ...
                Object.defineProperty(g, "name", { value: "node (" + (a.type + (v ? "<" + v + ">" : "")) + ")" });
            }
            return g;
            function g() {
                let v = [],
...
function FB(e, t) {
    ...
    return (
        (s.dangerous = r),
        (s.clobberPrefix = n.clobberPrefix === void 0 || n.clobberPrefix === null ? "user-content-" : n.clobberPrefix),
    ...
    function l(d, p) {
        if (d && "data" in d && d.data) {
            const g = d.data;
            g.hName && (p.type !== "element" && (p = { type: "element", tagName: "", properties: {}, children: [] }), (p.tagName = g.hName)),
                p.type === "element" && g.hProperties && (p.properties = { ...p.properties, ...g.hProperties }),
    ...
    function s(d, p, g, v) {
        return Array.isArray(g) && ((v = g), (g = {})), l(d, { type: "element", tagName: p, properties: g || {}, children: v || [] });
    }
    function a(d, p) {
        return R_(s, d, p);
    }
...
function R_(e, t, n) {
    ...
    return ef.call(e.handlers, r) ? e.handlers[r](e, t, n) : e.passThrough && e.passThrough.includes(r) ? ("children" in t ? { ...t, children: Pv(e, t) } : t) : e.unknownHandler ? e.unknownHandler(e, t, n) : BB(e, t);
}
function Pv(e, t) {
    const n = [];
    if ("children" in t) {
...
function BB(e, t) {
    const n = t.data || {},
        r = "value" in t && !(ef.call(n, "hProperties") || ef.call(n, "hChildren")) ? { type: "text", value: t.value } : { type: "element", tagName: "div", properties: {}, children: Pv(e, t) };
    return e.patch(t, r), e.applyData(t, r);
}
function UB(e, t) {
    const n = [];
...
function HB(e) {
    ...
    for (; ++n < e.footnoteOrder.length;) {
        ...
        for (; ++a <= e.footnoteCounts[l];) {
            const g = {
                type: "element",
                tagName: "a",
                properties: { href: "#" + e.clobberPrefix + "fnref-" + s + (a > 1 ? "-" + a : ""), dataFootnoteBackref: !0, className: ["data-footnote-backref"], ariaLabel: e.footnoteBackLabel },
                children: [{ type: "text", value: "↩" }],
            };
            a > 1 && g.children.push({ type: "element", tagName: "sup", children: [{ type: "text", value: String(a) }] }), f.length > 0 && f.push({ type: "text", value: " " }), f.push(g);
        }
        const d = i[i.length - 1];
        if (d && d.type === "element" && d.tagName === "p") {
            const g = d.children[d.children.length - 1];
            g && g.type === "text" ? (g.value += " ") : d.children.push({ type: "text", value: " " }), d.children.push(...f);
        } else i.push(...f);
        const p = { type: "element", tagName: "li", properties: { id: e.clobberPrefix + "fn-" + s }, children: e.wrap(i, !0) };
    ...
    if (t.length !== 0)
        return {
            ...
            children: [
                { type: "element", tagName: e.footnoteLabelTagName, properties: { ...JSON.parse(JSON.stringify(e.footnoteLabelProperties)), id: "footnote-label" }, children: [{ type: "text", value: e.footnoteLabel }] },
                {
                    type: "text",
                    value: `
`,
...
const Dg = Object.freeze(
    Object.defineProperty({ __proto__: null, boolean: be, booleanish: kt, commaOrSpaceSeparated: An, commaSeparated: Fl, number: ie, overloadedBoolean: D_, spaceSeparated: tt }, Symbol.toStringTag, { value: "Module" })
),
    hh = Object.keys(Dg);
class Av extends dr {
    constructor(t, n, r, i) {
...
const z_ = lu({ space: "xmlns", attributes: { xmlnsxlink: "xmlns:xlink" }, transform: F_, properties: { xmlns: null, xmlnsXLink: null } }),
    $_ = lu({
        transform(e, t) {
    ...
    if (e.allowedElements || e.disallowedElements || e.allowElement)
        return (t) => {
            Rv(t, "element", (n, r, i) => {
                ...
                let s;
                if (
                    (e.allowedElements ? (s = !e.allowedElements.includes(n.tagName)) : e.disallowedElements && (s = e.disallowedElements.includes(n.tagName)),
    ...
    yU = function (e, t) {
        ...
        function v() {
            ...
            if (S) {
                ...
                var A = f(dU),
                    y = E({ type: vU, property: iS(S[0].replace(tS, _o)), value: A ? iS(A[0].replace(tS, _o)) : _o });
                return f(pU), y;
            }
        }
        function m() {
...
function U_(e, t) {
    ...
    for (; ++r < t.children.length;)
        (i = t.children[r]), i.type === "element" ? n.push(CU(e, i, r, t)) : i.type === "text" ? (t.type !== "element" || !EU.has(t.tagName) || !oU(i)) && n.push(i.value) : i.type === "raw" && !e.options.skipHtml && n.push(i.value);
    return n;
}
function CU(e, t, n, r) {
    const i = e.options,
    ...
    let d = s,
        p;
    if ((s.space === "html" && a === "svg" && ((d = rU), (e.schema = d)), t.properties)) for (p in t.properties) Ng.call(t.properties, p) && _U(f, p, t.properties[p], e);
    (a === "ol" || a === "ul") && e.listDepth++;
    const g = U_(e, t);
    (a === "ol" || a === "ul") && e.listDepth--, (e.schema = s);
    const v = t.position || { start: { line: null, column: null, offset: null }, end: { line: null, column: null, offset: null } },
    ...
    if (
        ((f.key = n),
            a === "a" && i.linkTarget && (f.target = typeof i.linkTarget == "function" ? i.linkTarget(String(f.href || ""), t.children, typeof f.title == "string" ? f.title : null) : i.linkTarget),
            a === "a" && l && (f.href = l(String(f.href || ""), t.children, typeof f.title == "string" ? f.title : null)),
            !E && a === "code" && r.type === "element" && r.tagName !== "pre" && (f.inline = !0),
            !E && (a === "h1" || a === "h2" || a === "h3" || a === "h4" || a === "h5" || a === "h6") && (f.level = Number.parseInt(a.charAt(1), 10)),
            a === "img" && i.transformImageUri && (f.src = i.transformImageUri(String(f.src || ""), String(f.alt || ""), typeof f.title == "string" ? f.title : null)),
    ...
    return (
        ...
        (a === "td" || a === "th") && (f.align && (f.style || (f.style = {}), (f.style.textAlign = f.align), delete f.align), E || (f.isHeader = a === "th")),
...
function _U(e, t, n, r) {
    ...
    l == null ||
        ...
        (Array.isArray(l) && (l = i.commaSeparated ? uU(l) : lU(l)),
            ...
            i.space && i.property ? (e[Ng.call(eS, i.property) ? eS[i.property] : i.property] = l) : i.attribute && (e[i.attribute] = l));
}
function bU(e) {
    const t = {};
    try {
...
const RU = () =>
    we("svg", {
        ...
        children: [W("path", { stroke: "none", d: "M0 0h24v24H0z", fill: "none" }), W("circle", { cx: "12", cy: "12", r: "9" }), W("polyline", { points: "12 7 12 12 15 15" })],
    }),
    ...
    PU = ({ item: e, inventoryType: t, style: n }, r) => {
        ...
        return W(En, {
            children: l
                    ...
                    children: [
                        we("div", {
                            ...
                            children: [
                                ...
                                t === "crafting"
                                    ? we("div", { className: "tooltip-crafting-duration", children: [W(RU, {}), we("p", { children: [(e.duration !== void 0 ? e.duration : 3e3) / 1e3, "s"] })] })
                                    : W("p", { children: e.metadata?.type }),
                            ],
                        }),
                        W(lS, {}),
                        a && W("div", { className: "tooltip-description", children: W(H_, { className: "tooltip-markdown", children: a }) }),
                        t !== "crafting"
                            ? we(En, {
                                children: [
                                    e.durability !== void 0 && we("p", { children: [ut.ui_durability, ": ", Math.trunc(e.durability)] }),
                                    e.metadata?.ammo !== void 0 && we("p", { children: [ut.ui_ammo, ": ", e.metadata.ammo] }),
                                    f && we("p", { children: [ut.ammo_type, ": ", f] }),
                                    e.metadata?.serial && we("p", { children: [ut.ui_serial, ": ", e.metadata.serial] }),
                                    e.metadata?.components &&
                                    e.metadata?.components[0] &&
                                    we("p", { children: [ut.ui_components, ":", " ", (e.metadata?.components).map((d, p, g) => (p + 1 === g.length ? dt[d]?.label : dt[d]?.label + ", "))] }),
                                    e.metadata?.weapontint && we("p", { children: [ut.ui_tint, ": ", e.metadata.weapontint] }),
                                    i.map((d, p) => W(I.Fragment, { children: e.metadata && e.metadata[d.metadata] && we("p", { children: [d.value, ": ", e.metadata[d.metadata]] }) }, `metadata-${p}`)),
                                ],
                            })
                            : W("div", {
                                        ...
                                        return we(
                                            "div",
                                            {
                                                ...
                                                children: [
                                                    ...
                                                    W("p", { children: g >= 1 ? `${g}x ${dt[p]?.label || p}` : g === 0 ? `${dt[p]?.label || p}` : g < 1 && `${g * 100}% ${dt[p]?.label || p}` }),
                                                ],
                                            },
                                            `ingredient-${p}`
                                        );
                ...
                : we("div", { className: "tooltip-wrapper", ref: r, style: n, children: [W("div", { className: "tooltip-header-wrapper", children: W("p", { children: e.name }) }), W(lS, {})] }),
        });
    },
    AU = Ve.forwardRef(PU),
    DU = () => {
        const e = gi((a) => a.tooltip),
            { refs: t, context: n, floatingStyles: r } = yv({ middleware: [Nk(), Dk(), Ak({ mainAxis: 10, crossAxis: 10 })], open: e.open, placement: "right-start" }),
        ...
        return (
            ...
            W(En, { children: i && e.item && e.inventoryType && W(vv, { children: W(AU, { ref: t.setFloating, style: { ...r, ...l }, item: e.item, inventoryType: e.inventoryType }) }) })
        );
    },
    NU = (e) => {
    ...
    Mg = Ve.createContext({ getItemProps: () => ({}), activeIndex: null, setActiveIndex: () => { }, setHasFocusInside: () => { }, isOpen: !1 }),
    uS = Ve.forwardRef(({ children: e, label: t, ...n }, r) => {
        const i = gi((oe) => oe.contextMenu),
            ...
            y = Uk(),
            x = A != null,
            { floatingStyles: k, refs: P, context: N } = yv({
                nodeId: S,
                open: l,
                onOpenChange: s,
            ...
            x ||
                (i.coords &&
                    (P.setPositionReference({
                        getBoundingClientRect() {
                            return { width: 0, height: 0, x: i.coords.x, y: i.coords.y, top: i.coords.y, right: i.coords.x, bottom: i.coords.y, left: i.coords.x };
                        },
                    }),
                        s(!0)),
                    i.coords || s(!1));
        }, [i]);
        const z = kz(N, { enabled: x, delay: { open: 75 }, handleClose: Kz({ blockPointerEvents: !0 }) }),
            ...
            we(Ez, {
                ...
                children: [
                    ...
                    we("button", {
                        ...
                        children: [t, x && W("span", { "aria-hidden": !0, style: { marginLeft: 10, fontSize: 10 }, children: "▶" })],
                    }),
                    W(Mg.Provider, {
                        value: { activeIndex: d, setActiveIndex: p, getItemProps: ue, setHasFocusInside: f, isOpen: l },
                        children: W(vz, {
                            elementsRef: g,
                            labelsRef: v,
                            children:
                                ...
                                W(vv, {
                                    children: W(Zk, {
                                        lockScroll: !0,
                                        children: W(Xk, { context: N, modal: !0, initialFocus: P.floating, children: W("div", { ref: P.setFloating, className: "context-menu-list", style: { ...k, ...F }, ...Z(), children: e }) }),
                                    }),
                                }),
                        }),
                    }),
    ...
    mh = Ve.forwardRef((e, t) => (Vo() === null ? W(Cz, { children: W(uS, { ...e, ref: t }) }) : W(uS, { ...e, ref: t }))),
    MU = () => {
            ...
            r = (i) =>
                i.reduce((l, s, a) => {
                    if (s.group) {
                        ...
                        f !== -1 ? l[f].buttons.push({ ...s, index: a }) : l.push({ groupName: s.group, buttons: [{ ...s, index: a }] });
        ...
        return W(En, {
            children: we(mh, {
                children: [
                    ...
                    t && t.metadata?.ammo > 0 && W(Ri, { onClick: () => n({ action: "removeAmmo" }), label: ut.ui_remove_ammo }),
                    t && t.metadata?.serial && W(Ri, { onClick: () => n({ action: "copy", serial: t.metadata?.serial }), label: ut.ui_copy }),
                    t &&
                    t.metadata?.components &&
                    t.metadata?.components.length > 0 &&
                    W(mh, { label: ut.ui_removeattachments, children: t && t.metadata?.components.map((i, l) => W(Ri, { onClick: () => n({ action: "remove", component: i, slot: t.slot }), label: dt[i]?.label || "" }, l)) }),
                                ...
                                W(
                                    Ve.Fragment,
                                    {
                                        children: i.groupName
                                            ? W(mh, { label: i.groupName, children: i.buttons.map((s) => W(Ri, { onClick: () => n({ action: "custom", id: s.index }), label: s.label }, s.index)) })
                                            : i.buttons.map((s) => W(Ri, { onClick: () => n({ action: "custom", id: s.index }), label: s.label }, s.index)),
                                    },
                                    l
                                )
                            ),
    ...
    j_ = (e) => {
        const t = I.useRef(null);
        return W(o_, { in: e.in, nodeRef: t, classNames: "transition-fade", timeout: 200, unmountOnExit: !0, children: W("span", { ref: t, children: e.children }) });
    },
    LU = () => {
        const [e, t] = I.useState(!1),
            n = ru();
        return (
            ...
            we(En, { children: [W(j_, { in: e, children: we("div", { className: "inventory-wrapper", children: [W(O6, {}), W(Yz, {}), W(b6, {}), W(DU, {}), W(MU, {})] }) }), W(g6, {})] })
        );
    },
    ...
    $U = () => {
        const e = I.useRef(null),
            { data: t, isDragging: n, currentOffset: r } = DF((i) => ({ data: i.getItem(), currentOffset: zU(i, e), isDragging: i.isDragging() }));
        return W(En, { children: n && r && t.item && W("div", { className: "item-drag-preview", ref: e, style: { transform: `translate(${r.x}px, ${r.y}px)`, backgroundImage: t.image } }) });
    },
    BU = (e) => {
...
const jU = (e = []) => {
    ...
    VU = Ve.forwardRef((e, t) => {
        ...
        return W("div", {
            ...
            children: we("div", {
                className: "item-slot-wrapper",
                children: [
                    W("div", { className: "item-notification-action-box", children: W("p", { children: e.item.text }) }),
                    W("div", { className: "inventory-slot-label-box", children: W("div", { className: "inventory-slot-label-text", children: n.metadata?.label || dt[n.name]?.label }) }),
                ],
            }),
        });
    }),
    qU = ({ children: e }) => {
        ...
        return (
            ...
            we(WU.Provider, {
                value: { add: n },
                children: [e, tu.createPortal(W(p6, { className: "item-notification-container", children: t.values.map((r, i) => W(j_, { children: W(VU, { item: r.item, ref: r.ref }) }, `item-notification-${i}`)) }), document.body)],
            })
        );
    },
...
SC(Bu).render(W(Ve.StrictMode, { children: W(FM, { store: Nn, children: W(aF, { backend: YF, options: { enableMouseEvents: !0 }, children: W(qU, { children: W(HU, {}) }) }) }) }));
