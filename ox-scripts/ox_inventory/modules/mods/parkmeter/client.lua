...
function Parkmeter.Functions.HasJob()
    ...
    if (PlayerData.job == "police" or PlayerData.job.name == "police") then
        hasJob = true
    end
    return hasJob
end
...
if shared.target then
    ...
    exports.ox_target:addModel(Parkmeter.Models, {{
        ...
        onSelect = function(data)
            return Parkmeter.Functions.PayFee(data.entity)
        end,
        distance = 2
    }, {
        type = "client",
        ...
        onSelect = function(data)
            return TriggerServerEvent('ox_inventory:checkmeter', GetEntityCoords(data.entity))
        end,
        distance = 2
    }, {
        type = "client",
        ...
        onSelect = function(data)
            return Parkmeter.Functions.Lockpick(data.entity)
        end,
        distance = 2
    }})
end
