FuelScript = 'LegacyFuel' -- LegacyFuel or ox_fuel or cdn-fuel
...
HouseParkingDrawText = 'Parkeerplaats' -- text when driving on to the HOUSE parking lot
...
Garages = {
    ...
    ['lsmotorsgarage'] = {
        ['Zone'] = {
            ['Shape'] = {
                vector2(173.277053833, -1071.7678222656),
                vector2(173.04203796386, -1072.679321289),
                vector2(174.38722229004, -1073.189086914),
                vector2(174.0435333252, -1075.9803466796),
                vector2(174.22021484375, -1076.0057373046),
                vector2(174.27494812012, -1077.4737548828),
                vector2(173.05094909668, -1084.023803711),
                vector2(168.1788635254, -1083.954711914),
                vector2(164.3334197998, -1084.937866211),
                vector2(115.21592712402, -1084.9523925782),
                vector2(112.43769836426, -1084.5369873046),
                vector2(98.414680480958, -1079.6258544922),
                vector2(95.576278686524, -1078.164428711),
                vector2(109.91661834716, -1046.1784667968),
                vector2(142.52976989746, -1057.0710449218),
                vector2(151.18090820312, -1063.5645751954),
            },
            ['minZ'] = 26.193788528442,
            ['maxZ'] = 32.193788528442,
        },
        label = 'Rolleman Ave Parkeerplaats',
        showBlip = true,
        blipcoords = vector3(100.5427, -1073.4159, 29.3741),
        ...
        debug = false,
        ['ParkingSpots'] = {
            vector4(162.1253, -1081.5205, 28.8512, 0.5288),
            vector4(158.3951, -1081.3856, 28.8514, 0.5464),
            vector4(154.6712, -1081.5594, 28.8521, 0.2717),
            vector4(150.8716, -1081.6262, 28.8515, 359.4838),
            vector4(147.1665, -1081.6660, 28.8516, 0.3925),
            vector4(143.5763, -1081.6846, 28.8507, 359.6268),
            vector4(139.8262, -1081.5790, 28.8529, 359.7809),
            vector4(136.0081, -1081.3881, 28.8523, 0.9653),
            vector4(132.2780, -1081.6581, 28.8520, 359.3492),
            vector4(128.6318, -1081.4283, 28.8527, 0.4057),
            vector4(124.9098, -1081.2955, 28.8525, 0.9779),
            vector4(121.1808, -1081.6774, 28.8514, 0.3556),
            vector4(117.5449, -1081.6978, 28.8524, 359.9288),
            vector4(118.9884, -1069.8688, 28.8510, 359.1198),
            vector4(122.3337, -1070.1692, 28.8511, 0.1205),
            vector4(125.6486, -1070.2483, 28.8581, 359.4717),
            vector4(128.8963, -1070.1061, 28.8512, 359.9209),
            vector4(132.2993, -1070.0973, 28.8807, 0.2589),
            vector4(135.4836, -1070.0227, 28.8518, 359.7758),
            vector4(138.7943, -1070.0409, 28.8521, 0.4457),
            vector4(111.9766, -1049.5625, 28.8739, 65.9833),
            vector4(110.6064, -1052.9968, 28.8675, 65.6718),
            vector4(108.9483, -1056.2905, 28.8663, 65.3133),
            vector4(107.5570, -1059.7502, 28.8647, 66.2765),
            vector4(105.9153, -1063.1367, 28.8690, 67.3348),
        }
    },
    ...
    ['pillboxlowergarage'] = {
        ...
        label = 'Ziekenhuis Parkeerplaats',
        showBlip = true,
    ...
    ['mirrorpark'] = {
        ...
        label = 'Mirror Park Parkeerplaats',
        showBlip = true,
    ...
    ['leigonsquarealley'] = {
        ...
        label = 'Blokkenpark Parkeerplaats',
        showBlip = true,
    ...
    ['airportp'] = {
        ['Zone'] = {
            ...
            ['minZ'] = 4.85,  -- min height of the parking zone
            ['maxZ'] = 10.10,  -- max height of the parking zone
        },
        label = "Vliegveld Parkeerplaats",
        showBlip = true,
    ...
    ['impoundlot'] = {
        ['Zone'] = {
            ['Shape'] = { --polygon that surrounds the parking area
                vector2(409.59140014648, -1616.1040039062),
                vector2(423.82312011718, -1627.7747802734),
                vector2(424.17193603516, -1646.193359375),
                vector2(410.60064697266, -1662.0391845704),
                vector2(387.73370361328, -1641.423828125)
            },
            ['minZ'] = 29.291915893554,  -- min height of the parking zone
            ['maxZ'] = 44.944675445556,  -- max height of the parking zone
            debug = false,
        },
        label = "De Domeinen",
        showBlip = true,
        blipcoords = vector3(409.58834, -1640.568, 29.291938),
        blipName = "De Domeinen",
        blipNumber = 68,
        ...
        debug = false,
        ['ParkingSpots'] = {
            vector4(420.89773, -1638.981, 29.291988, 92.097702),
            vector4(421.00314, -1641.998, 29.290674, 91.576171),
            vector4(418.78167, -1646.774, 29.291957, 48.934501),
            vector4(419.80303, -1629.258, 29.291923, 146.61486),
            vector4(417.39535, -1627.254, 29.29195, 144.04776),
            vector4(396.71755, -1643.85, 29.29195, 140.13586),
            vector4(398.88903, -1646.098, 29.29195, 137.85742),
            vector4(401.17523, -1648.231, 29.292589, 140.74636),
            vector4(403.57305, -1650.392, 29.293958, 141.80661),
            vector4(405.98306, -1652.304, 29.292469, 138.81626),
            vector4(408.42593, -1654.257, 29.291889, 140.92298),
            vector4(410.94128, -1656.633, 29.291889, 137.07949),
        }
    },
    ['mechanic'] = {
        ['Zone'] = {
    ...
    ['cityhall'] = {
        ...
        label = 'Gemeentehuis Parkeerplaats',
        type = 'public',
        vehicleCategories = {'car', 'motorcycle', 'other', 'commercial'},
        drawText = 'Parking',
        ["ParkingSpots"] = {
    ...
    ['odin'] = {
        ['Zone'] = {
            ['Shape'] = { --polygon that surrounds the parking area
                vector2(155.2593, 320.1167),
                vector2(152.8708, 327.6994),
                vector2(142.1889, 322.9156),
                vector2(145.3084, 315.7598),
                vector2(155.2591, 320.1163),
            },
            ['minZ'] = 100.0,  -- min height of the parking zone
            ['maxZ'] = 150.0,  -- max height of the parking zone
        },
        label = 'Viatores Trailertrash', 
        type = 'gang',
        vehicleCategories = {'car', 'motorcycle'},
        drawText = 'Sons of Odin',
        showBlip = false, 
        blipName = 'Sons of Odin',
        blipNumber = 359,
        blipColor = 50, 
        blipcoords = vector3(137.2619, 312.5117, 112.1387),
        ParkingDistance = 100.0,
        SpawnDistance = 100.0,
        job = "odin",
        debug = false,
        ['ParkingSpots'] = {
            vector4(148.5669, 321.3036, 111.9181, 113.5743),
        },
    },
    ['havengarage'] = {
        ['Zone'] = {
            ['Shape'] = { --polygon that surrounds the parking area
                vector2(168.3049, -3011.0605),
                vector2(168.3428, -2987.4968),
                vector2(159.2122, -2987.2532),
                vector2(159.0604, -3010.7280),
                vector2(168.3049, -3011.0605)
            },
        ...
        type = 'public',
        vehicleCategories = {'car', 'motorcycle', 'other', 'commercial'},
        drawText = 'Haven Garage',
        showBlip = true, 
        blipName = 'Haven Garage',
        blipNumber = 357,
        blipColor = 38, 
        blipcoords = vector3(165.6400, -2999.5420, 5.8926),
        ParkingDistance = 100.0,
        SpawnDistance = 100.0,
        debug = false,
        ['ParkingSpots'] = {
            vector4(163.2289, -3009.3259, 5.5245, 269.0807),
            vector4(163.0987, -3006.1003, 5.5269, 269.6535),
            vector4(163.2532, -3002.8591, 5.5239, 269.6234),
            vector4(163.2254, -2996.2512, 5.5227, 270.5676),
            vector4(163.2525, -2993.0654, 5.5164, 270.0251),
            vector4(163.2654, -2989.8726, 5.5026, 269.7977)
        },
    },
}
